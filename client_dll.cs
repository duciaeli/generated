...
// 2024-08-11 01:10:56.152836800 UTC
...
namespace CS2Dumper.Schemas {
    ...
    public static class ClientDll {
        ...
        public static class CCSPlayer_MovementServices {
            ...
            public const nint m_nOldWaterLevel = 0x47C; // 
            public const nint m_flWaterEntryTime = 0x480; // 
            public const nint m_vecForward = 0x484; // 
            public const nint m_vecLeft = 0x490; // 
            public const nint m_vecUp = 0x49C; // 
            public const nint m_nGameCodeHasMovedPlayerAfterCommand = 0x4A8; // 
            ...
            public const nint m_flHeightAtJumpStart = 0x4D4; // 
            public const nint m_flMaxJumpHeightThisJump = 0x4D8; // 
        }
        // Parent: None
        // Field count: 6
        //
        ...
        public static class C_Item {
            public const nint m_pReticleHintTextName = 0x15B0; // 
        }
        ...
        public static class C_SoundEventPathCornerEntity {
            public const nint m_vecCornerPairsNetworked = 0x548; // 
        }
        // Parent: C_CSWeaponBaseGun
        // Field count: 0
        ...
        public static class C_CSGameRules {
            ...
            public const nint m_nMatchAbortedEarlyReason = 0xD28; // 
            public const nint m_bHasTriggeredRoundStartMusic = 0xD2C; // 
            public const nint m_bSwitchingTeamsAtRoundReset = 0xD2D; // 
            public const nint m_pGameModeRules = 0xD48; // 
            public const nint m_RetakeRules = 0xD50; // 
            public const nint m_nMatchEndCount = 0xE68; // 
            public const nint m_nTTeamIntroVariant = 0xE6C; // 
            public const nint m_nCTTeamIntroVariant = 0xE70; // 
            public const nint m_bTeamIntroPeriod = 0xE74; // 
            public const nint m_iRoundEndWinnerTeam = 0xE78; // 
            public const nint m_eRoundEndReason = 0xE7C; // 
            public const nint m_bRoundEndShowTimerDefend = 0xE80; // 
            public const nint m_iRoundEndTimerTime = 0xE84; // 
            public const nint m_sRoundEndFunFactToken = 0xE88; // 
            public const nint m_iRoundEndFunFactPlayerSlot = 0xE90; // 
            public const nint m_iRoundEndFunFactData1 = 0xE94; // 
            public const nint m_iRoundEndFunFactData2 = 0xE98; // 
            public const nint m_iRoundEndFunFactData3 = 0xE9C; // 
            public const nint m_sRoundEndMessage = 0xEA0; // 
            public const nint m_iRoundEndPlayerCount = 0xEA8; // 
            public const nint m_bRoundEndNoMusic = 0xEAC; // 
            public const nint m_iRoundEndLegacy = 0xEB0; // 
            public const nint m_nRoundEndCount = 0xEB4; // 
            public const nint m_iRoundStartRoundNumber = 0xEB8; // 
            public const nint m_nRoundStartCount = 0xEBC; // 
            public const nint m_flLastPerfSampleTime = 0x4EC8; // 
        }
        ...
        public static class C_BaseModelEntity {
            public const nint m_CRenderComponent = 0xA18; // 
            public const nint m_CHitboxComponent = 0xA20; // 
            public const nint m_bInitModelEffects = 0xA68; // 
            public const nint m_bIsStaticProp = 0xA69; // 
            public const nint m_nLastAddDecal = 0xA6C; // 
            public const nint m_nDecalsAdded = 0xA70; // 
            public const nint m_iOldHealth = 0xA74; // 
            public const nint m_nRenderMode = 0xA78; // 
            public const nint m_nRenderFX = 0xA79; // 
            public const nint m_bAllowFadeInView = 0xA7A; // 
            public const nint m_clrRender = 0xA7B; // 
            public const nint m_vecRenderAttributes = 0xA80; // 
            public const nint m_bRenderToCubemaps = 0xAE8; // 
            public const nint m_Collision = 0xAF0; // 
            public const nint m_Glow = 0xBA0; // 
            public const nint m_flGlowBackfaceMult = 0xBF8; // 
            public const nint m_fadeMinDist = 0xBFC; // 
            public const nint m_fadeMaxDist = 0xC00; // 
            public const nint m_flFadeScale = 0xC04; // 
            public const nint m_flShadowStrength = 0xC08; // 
            public const nint m_nObjectCulling = 0xC0C; // 
            public const nint m_nAddDecal = 0xC10; // 
            public const nint m_vDecalPosition = 0xC14; // 
            public const nint m_vDecalForwardAxis = 0xC20; // 
            public const nint m_flDecalHealBloodRate = 0xC2C; // 
            public const nint m_flDecalHealHeightRate = 0xC30; // 
            public const nint m_ConfigEntitiesToPropagateMaterialDecalsTo = 0xC38; // 
            public const nint m_vecViewOffset = 0xC50; // 
            public const nint m_pClientAlphaProperty = 0xC80; // 
            public const nint m_ClientOverrideTint = 0xC88; // 
            public const nint m_bUseClientOverrideTint = 0xC8C; // 
        }
        // Parent: C_BaseTrigger
        // Field count: 2
        //
        ...
        public static class C_FootstepControl {
            public const nint m_source = 0xCD0; // 
            public const nint m_destination = 0xCD8; // 
        }
        ...
        public static class C_PointClientUIHUD {
            public const nint m_bCheckCSSClasses = 0xD00; // 
        ...
        public static class C_SpotlightEnd {
            public const nint m_flLightScale = 0xCC8; // 
            public const nint m_Radius = 0xCCC; // 
        }
        // Parent: None
        // Field count: 5
        //
        ...
        public static class C_PointCamera {
            public const nint m_FOV = 0x548; // 
            public const nint m_Resolution = 0x54C; // 
            public const nint m_bFogEnable = 0x550; // 
            public const nint m_FogColor = 0x551; // 
            public const nint m_flFogStart = 0x558; // 
            public const nint m_flFogEnd = 0x55C; // 
            public const nint m_flFogMaxDensity = 0x560; // 
            public const nint m_bActive = 0x564; // 
            public const nint m_bUseScreenAspectRatio = 0x565; // 
            public const nint m_flAspectRatio = 0x568; // 
            public const nint m_bNoSky = 0x56C; // 
            public const nint m_fBrightness = 0x570; // 
            public const nint m_flZFar = 0x574; // 
            public const nint m_flZNear = 0x578; // 
            public const nint m_bCanHLTVUse = 0x57C; // 
            public const nint m_bDofEnabled = 0x57D; // 
            public const nint m_flDofNearBlurry = 0x580; // 
            public const nint m_flDofNearCrisp = 0x584; // 
            public const nint m_flDofFarCrisp = 0x588; // 
            public const nint m_flDofFarBlurry = 0x58C; // 
            public const nint m_flDofTiltToGround = 0x590; // 
            public const nint m_TargetFOV = 0x594; // 
            public const nint m_DegreesPerSecond = 0x598; // 
            public const nint m_bIsOn = 0x59C; // 
            public const nint m_pNext = 0x5A0; // 
        }
        // Parent: None
        // Field count: 0
        //
        ...
        public static class C_EnvWind {
            public const nint m_EnvWindShared = 0x548; // 
        }
        // Parent: C_BaseEntity
        // Field count: 0
        ...
        public static class C_BaseCombatCharacter {
            ...
            public const nint m_leftFootAttachment = 0x1080; // 
            public const nint m_rightFootAttachment = 0x1081; // 
            public const nint m_nWaterWakeMode = 0x1084; // C_BaseCombatCharacter::WaterWakeMode_t
            public const nint m_flWaterWorldZ = 0x1088; // 
            public const nint m_flWaterNextTraceTime = 0x108C; // 
            public const nint m_flFieldOfView = 0x1090; // 
        }
        ...
        public static class C_SoundEventSphereEntity {
            public const nint m_flRadius = 0x548; // 
        }
        ...
        public static class C_SceneEntity {
            public const nint m_bIsPlayingBack = 0x550; // 
            public const nint m_bPaused = 0x551; // 
            public const nint m_bMultiplayer = 0x552; // 
            public const nint m_bAutogenerated = 0x553; // 
            public const nint m_flForceClientTime = 0x554; // 
            public const nint m_nSceneStringIndex = 0x558; // 
            public const nint m_bClientOnly = 0x55A; // 
            public const nint m_hOwner = 0x55C; // 
            public const nint m_hActorList = 0x560; // 
            public const nint m_bWasPlaying = 0x578; // 
            public const nint m_QueuedEvents = 0x588; // 
            public const nint m_flCurrentTime = 0x5A0; // 
        }
        // Parent: CPlayerPawnComponent
        // Field count: 20
        //
        ...
        public static class C_BaseCSGrenade {
            public const nint m_bClientPredictDelete = 0x1A70; // 
            public const nint m_bRedraw = 0x1A71; // 
            public const nint m_bIsHeldByPlayer = 0x1A72; // 
            public const nint m_bPinPulled = 0x1A73; // 
            public const nint m_bJumpThrow = 0x1A74; // 
            public const nint m_bThrowAnimating = 0x1A75; // 
            public const nint m_fThrowTime = 0x1A78; // 
            public const nint m_flThrowStrength = 0x1A7C; // 
            public const nint m_flThrowStrengthApproach = 0x1A80; // 
            public const nint m_fDropTime = 0x1A84; // 
            public const nint m_fPinPullTime = 0x1A88; // 
            public const nint m_bJustPulledPin = 0x1A8C; // 
            public const nint m_nNextHoldTick = 0x1A90; // 
            public const nint m_flNextHoldFrac = 0x1A94; // 
            public const nint m_hSwitchToWeaponAfterThrow = 0x1A98; // 
        }
        // Parent: C_FuncBrush
        // Field count: 8
        //
        ...
        public static class C_FuncMonitor {
            public const nint m_targetCamera = 0xCC8; // 
            public const nint m_nResolutionEnum = 0xCD0; // 
            public const nint m_bRenderShadows = 0xCD4; // 
            public const nint m_bUseUniqueColorTarget = 0xCD5; // 
            public const nint m_brushModelName = 0xCD8; // 
            public const nint m_hTargetCamera = 0xCE0; // 
            public const nint m_bEnabled = 0xCE4; // 
            public const nint m_bDraw3DSkybox = 0xCE5; // 
        }
        // Parent: C_BaseTrigger
        // Field count: 0
        ...
        public static class C_LightGlow {
            public const nint m_nHorizontalSize = 0xCC8; // 
            public const nint m_nVerticalSize = 0xCCC; // 
            public const nint m_nMinDist = 0xCD0; // 
            public const nint m_nMaxDist = 0xCD4; // 
            public const nint m_nOuterMaxDist = 0xCD8; // 
            public const nint m_flGlowProxySize = 0xCDC; // 
            public const nint m_flHDRColorScale = 0xCE0; // 
            public const nint m_GlowOverlay = 0xCE8; // 
        }
        // Parent: None
        // Field count: 4
        //
        ...
        public static class C_ClientRagdoll {
            public const nint m_bFadeOut = 0xED0; // 
            public const nint m_bImportant = 0xED1; // 
            public const nint m_flEffectTime = 0xED4; // 
            public const nint m_gibDespawnTime = 0xED8; // 
            public const nint m_iCurrentFriction = 0xEDC; // 
            public const nint m_iMinFriction = 0xEE0; // 
            public const nint m_iMaxFriction = 0xEE4; // 
            public const nint m_iFrictionAnimState = 0xEE8; // 
            public const nint m_bReleaseRagdoll = 0xEEC; // 
            public const nint m_iEyeAttachment = 0xEED; // 
            public const nint m_bFadingOut = 0xEEE; // 
            public const nint m_flScaleEnd = 0xEF0; // 
            public const nint m_flScaleTimeStart = 0xF18; // 
            public const nint m_flScaleTimeEnd = 0xF40; // 
        }
        // Parent: C_BaseEntity
        // Field count: 1
        public static class C_GlobalLight {
            public const nint m_WindClothForceHandle = 0xA10; // 
        }
        // Parent: C_BaseEntity
        // Field count: 10
        //
        ...
        public static class C_CSPlayerResource {
            public const nint m_bHostageAlive = 0x548; // 
            public const nint m_isHostageFollowingSomeone = 0x554; // 
            public const nint m_iHostageEntityIDs = 0x560; // 
            public const nint m_bombsiteCenterA = 0x590; // 
            public const nint m_bombsiteCenterB = 0x59C; // 
            public const nint m_hostageRescueX = 0x5A8; // 
            public const nint m_hostageRescueY = 0x5B8; // 
            public const nint m_hostageRescueZ = 0x5C8; // 
            public const nint m_bEndMatchNextMapAllVoted = 0x5D8; // 
            public const nint m_foundGoalPositions = 0x5D9; // 
        }
        ...
        public static class C_SmokeGrenadeProjectile {
            public const nint m_nSmokeEffectTickBegin = 0x1158; // 
            public const nint m_bDidSmokeEffect = 0x115C; // 
            public const nint m_nRandomSeed = 0x1160; // 
            public const nint m_vSmokeColor = 0x1164; // 
            public const nint m_vSmokeDetonationPos = 0x1170; // 
            public const nint m_VoxelFrameData = 0x1180; // 
            public const nint m_bSmokeVolumeDataReceived = 0x1198; // 
            public const nint m_bSmokeEffectSpawned = 0x1199; // 
        }
        // Parent: C_SoundEventEntity
        // Field count: 0
        ...
        public static class C_CSGO_MapPreviewCameraPath {
            public const nint m_flZFar = 0x548; // 
            public const nint m_flZNear = 0x54C; // 
            public const nint m_bLoop = 0x550; // 
            public const nint m_bVerticalFOV = 0x551; // 
            public const nint m_bConstantSpeed = 0x552; // 
            public const nint m_flDuration = 0x554; // 
            public const nint m_flPathLength = 0x598; // 
            public const nint m_flPathDuration = 0x59C; // 
        }
        // Parent: CCSGO_WingmanIntroCharacterPosition
        // Field count: 0
        ...
        public static class C_Inferno {
            public const nint m_nfxFireDamageEffect = 0xD08; // 
            public const nint m_hInfernoPointsSnapshot = 0xD10; // 
            public const nint m_hInfernoFillerPointsSnapshot = 0xD18; // 
            public const nint m_hInfernoOutlinePointsSnapshot = 0xD20; // 
            public const nint m_hInfernoClimbingOutlinePointsSnapshot = 0xD28; // 
            public const nint m_hInfernoDecalsSnapshot = 0xD30; // 
            public const nint m_firePositions = 0xD38; // 
            public const nint m_fireParentPositions = 0x1038; // 
            public const nint m_bFireIsBurning = 0x1338; // 
            public const nint m_BurnNormal = 0x1378; // 
            public const nint m_fireCount = 0x1678; // 
            public const nint m_nInfernoType = 0x167C; // 
            public const nint m_nFireLifetime = 0x1680; // 
            public const nint m_bInPostEffectTime = 0x1684; // 
            public const nint m_lastFireCount = 0x1688; // 
            public const nint m_nFireEffectTickBegin = 0x168C; // 
            public const nint m_drawableCount = 0x8290; // 
            public const nint m_blosCheck = 0x8294; // 
            public const nint m_nlosperiod = 0x8298; // 
            public const nint m_maxFireHalfWidth = 0x829C; // 
            public const nint m_maxFireHeight = 0x82A0; // 
            public const nint m_minBounds = 0x82A4; // 
            public const nint m_maxBounds = 0x82B0; // 
            public const nint m_flLastGrassBurnThink = 0x82BC; // 
        }
        // Parent: CBaseAnimGraph
        // Field count: 0
        ...
        public static class C_PlayerPing {
            public const nint m_hPlayer = 0x578; // 
            public const nint m_hPingedEntity = 0x57C; // 
            public const nint m_iType = 0x580; // 
            public const nint m_bUrgent = 0x584; // 
            public const nint m_szPlaceName = 0x585; // 
        }
        // Parent: C_CSWeaponBaseGun
        // Field count: 0
        ...
        public static class C_CSTeam {
            public const nint m_szTeamMatchStat = 0x600; // 
            public const nint m_numMapVictories = 0x800; // 
            public const nint m_bSurrendered = 0x804; // 
            public const nint m_scoreFirstHalf = 0x808; // 
            public const nint m_scoreSecondHalf = 0x80C; // 
            public const nint m_scoreOvertime = 0x810; // 
            public const nint m_szClanTeamname = 0x814; // 
            public const nint m_iClanID = 0x898; // 
        ...
        public static class C_CSGO_MapPreviewCameraPathNode {
            public const nint m_szParentPathUniqueID = 0x548; // 
            public const nint m_nPathIndex = 0x550; // 
            public const nint m_vInTangentLocal = 0x554; // 
            public const nint m_vOutTangentLocal = 0x560; // 
            public const nint m_flFOV = 0x56C; // 
            public const nint m_flCameraSpeed = 0x570; // 
            public const nint m_flEaseIn = 0x574; // 
            public const nint m_flEaseOut = 0x578; // 
            public const nint m_vInTangentWorld = 0x57C; // 
            public const nint m_vOutTangentWorld = 0x588; // 
        }
        // Parent: C_CSWeaponBaseGun
        // Field count: 0
        ...
        public static class C_CSPlayerPawn {
            public const nint m_pBulletServices = 0x1468; // 
            public const nint m_pHostageServices = 0x1470; // 
            public const nint m_pBuyServices = 0x1478; // 
            public const nint m_pGlowServices = 0x1480; // 
            public const nint m_pActionTrackingServices = 0x1488; // CCSPlayer_ActionTrackingServices*
            public const nint m_flHealthShotBoostExpirationTime = 0x1490; // 
            public const nint m_flLastFiredWeaponTime = 0x1494; // 
            public const nint m_bHasFemaleVoice = 0x1498; // 
            public const nint m_flLandingTimeSeconds = 0x149C; // 
            public const nint m_flOldFallVelocity = 0x14A0; // 
            public const nint m_szLastPlaceName = 0x14A4; // 
            public const nint m_bPrevDefuser = 0x14B6; // 
            public const nint m_bPrevHelmet = 0x14B7; // 
            public const nint m_nPrevArmorVal = 0x14B8; // 
            public const nint m_nPrevGrenadeAmmoCount = 0x14BC; // 
            public const nint m_unPreviousWeaponHash = 0x14C0; // 
            public const nint m_unWeaponHash = 0x14C4; // 
            public const nint m_bInBuyZone = 0x14C8; // 
            public const nint m_bPreviouslyInBuyZone = 0x14C9; // 
            public const nint m_aimPunchAngle = 0x14CC; // 
            public const nint m_aimPunchAngleVel = 0x14D8; // 
            public const nint m_aimPunchTickBase = 0x14E4; // 
            public const nint m_aimPunchTickFraction = 0x14E8; // 
            public const nint m_aimPunchCache = 0x14F0; // 
            public const nint m_bInLanding = 0x1510; // 
            public const nint m_flLandingStartTime = 0x1514; // 
            public const nint m_bInHostageRescueZone = 0x1518; // 
            public const nint m_bInBombZone = 0x1519; // 
            public const nint m_bIsBuyMenuOpen = 0x151A; // 
            public const nint m_flTimeOfLastInjury = 0x151C; // 
            public const nint m_flNextSprayDecalTime = 0x1520; // 
            public const nint m_iRetakesOffering = 0x1650; // 
            public const nint m_iRetakesOfferingCard = 0x1654; // 
            public const nint m_bRetakesHasDefuseKit = 0x1658; // 
            public const nint m_bRetakesMVPLastRound = 0x1659; // 
            public const nint m_iRetakesMVPBoostItem = 0x165C; // 
            public const nint m_RetakesMVPBoostExtraUtility = 0x1660; // 
            public const nint m_bNeedToReApplyGloves = 0x1680; // 
            public const nint m_EconGloves = 0x1688; // 
            public const nint m_nEconGlovesChanged = 0x1AD0; // 
            public const nint m_bMustSyncRagdollState = 0x1AD1; // 
            public const nint m_nRagdollDamageBone = 0x1AD4; // 
            public const nint m_vRagdollDamageForce = 0x1AD8; // 
            public const nint m_vRagdollDamagePosition = 0x1AE4; // 
            public const nint m_szRagdollDamageWeaponName = 0x1AF0; // 
            public const nint m_bRagdollDamageHeadshot = 0x1B30; // 
            public const nint m_vRagdollServerOrigin = 0x1B34; // 
            public const nint m_bLastHeadBoneTransformIsValid = 0x2148; // 
            public const nint m_lastLandTime = 0x214C; // 
            public const nint m_bOnGroundLastTick = 0x2150; // 
            public const nint m_qDeathEyeAngles = 0x216C; // 
            public const nint m_bSkipOneHeadConstraintUpdate = 0x2178; // 
            public const nint m_bLeftHanded = 0x2179; // 
            public const nint m_fSwitchedHandednessTime = 0x217C; // 
            public const nint m_flViewmodelOffsetX = 0x2180; // 
            public const nint m_flViewmodelOffsetY = 0x2184; // 
            public const nint m_flViewmodelOffsetZ = 0x2188; // 
            public const nint m_flViewmodelFOV = 0x218C; // 
            public const nint m_vecPlayerPatchEconIndices = 0x2190; // 
            public const nint m_GunGameImmunityColor = 0x21C8; // 
            public const nint m_vecBulletHitModels = 0x2218; // 
            public const nint m_bIsWalking = 0x2230; // 
            public const nint m_thirdPersonHeading = 0x2238; // 
            public const nint m_flSlopeDropOffset = 0x2250; // 
            public const nint m_flSlopeDropHeight = 0x2260; // 
            public const nint m_vHeadConstraintOffset = 0x2270; // 
            public const nint m_entitySpottedState = 0x2288; // 
            public const nint m_bIsScoped = 0x22A0; // 
            public const nint m_bResumeZoom = 0x22A1; // 
            public const nint m_bIsDefusing = 0x22A2; // 
            public const nint m_bIsGrabbingHostage = 0x22A3; // 
            public const nint m_iBlockingUseActionInProgress = 0x22A4; // 
            public const nint m_flEmitSoundTime = 0x22A8; // 
            public const nint m_bInNoDefuseArea = 0x22AC; // 
            public const nint m_nWhichBombZone = 0x22B0; // 
            public const nint m_iShotsFired = 0x22B4; // 
            public const nint m_flVelocityModifier = 0x22B8; // 
            public const nint m_flHitHeading = 0x22BC; // 
            public const nint m_nHitBodyPart = 0x22C0; // 
            public const nint m_bWaitForNoAttack = 0x22C4; // 
            public const nint m_ignoreLadderJumpTime = 0x22C8; // 
            public const nint m_bKilledByHeadshot = 0x22CD; // 
            public const nint m_ArmorValue = 0x22D0; // 
            public const nint m_unCurrentEquipmentValue = 0x22D4; // 
            public const nint m_unRoundStartEquipmentValue = 0x22D6; // 
            public const nint m_unFreezetimeEndEquipmentValue = 0x22D8; // 
            public const nint m_nLastKillerIndex = 0x22DC; // 
            public const nint m_bOldIsScoped = 0x22E0; // 
            public const nint m_bHasDeathInfo = 0x22E1; // 
            public const nint m_flDeathInfoTime = 0x22E4; // 
            public const nint m_vecDeathInfoOrigin = 0x22E8; // 
            public const nint m_grenadeParameterStashTime = 0x22F4; // 
            public const nint m_bGrenadeParametersStashed = 0x22F8; // 
            public const nint m_angStashedShootAngles = 0x22FC; // 
            public const nint m_vecStashedGrenadeThrowPosition = 0x2308; // 
            public const nint m_vecStashedVelocity = 0x2314; // 
            public const nint m_angShootAngleHistory = 0x2320; // 
            public const nint m_vecThrowPositionHistory = 0x2338; // 
            public const nint m_vecVelocityHistory = 0x2350; // 
        }
        ...
        public static class C_RagdollPropAttached {
            public const nint m_boneIndexAttached = 0xF48; // 
            public const nint m_ragdollAttachedObjectIndex = 0xF4C; // 
            public const nint m_attachmentPointBoneSpace = 0xF50; // 
            public const nint m_attachmentPointRagdollSpace = 0xF5C; // 
            public const nint m_vecOffset = 0xF68; // 
            public const nint m_parentTime = 0xF74; // 
            public const nint m_bHasParent = 0xF78; // 
        }
        ...
        public static class C_BaseCSGrenadeProjectile {
            public const nint m_vInitialPosition = 0x10B8; // 
            public const nint m_vInitialVelocity = 0x10C4; // 
            public const nint m_nBounces = 0x10D0; // 
            public const nint m_nExplodeEffectIndex = 0x10D8; // 
            public const nint m_nExplodeEffectTickBegin = 0x10E0; // 
            public const nint m_vecExplodeEffectOrigin = 0x10E4; // 
            public const nint m_flSpawnTime = 0x10F0; // 
            public const nint vecLastTrailLinePos = 0x10F4; // 
            public const nint flNextTrailLineTime = 0x1100; // 
            public const nint m_bExplodeEffectBegan = 0x1104; // 
            public const nint m_bCanCreateGrenadeTrail = 0x1105; // 
            public const nint m_nSnapshotTrajectoryEffectIndex = 0x1108; // 
            public const nint m_hSnapshotTrajectoryParticleSnapshot = 0x1110; // 
            public const nint m_arrTrajectoryTrailPoints = 0x1118; // 
            public const nint m_arrTrajectoryTrailPointCreationTimes = 0x1130; // 
            public const nint m_flTrajectoryTrailEffectCreationTime = 0x1148; // 
        }
        // Parent: C_BaseToggle
        // Field count: 2
        //
        ...
        public static class C_BaseTrigger {
            public const nint m_bDisabled = 0xCC8; // 
            public const nint m_bClientSidePredicted = 0xCC9; // 
        }
        // Parent: C_CSWeaponBase
        // Field count: 2
        //
        ...
        public static class C_WeaponBaseItem {
            public const nint m_SequenceCompleteTimer = 0x1A70; // 
            public const nint m_bRedraw = 0x1A88; // 
        }
        // Parent: None
        // Field count: 21
        //
        ...
        public static class C_BaseButton {
            public const nint m_glowEntity = 0xCC8; // 
            public const nint m_usable = 0xCCC; // 
            public const nint m_szDisplayText = 0xCD0; // 
        }
        ...
        public static class C_PointClientUIWorldPanel {
            public const nint m_bForceRecreateNextUpdate = 0xD00; // 
            public const nint m_bMoveViewToPlayerNextThink = 0xD01; // 
            public const nint m_bCheckCSSClasses = 0xD02; // 
            public const nint m_anchorDeltaTransform = 0xD10; // 
            public const nint m_pOffScreenIndicator = 0xEA8; // 
            public const nint m_bIgnoreInput = 0xED0; // 
            public const nint m_bLit = 0xED1; // 
            public const nint m_bFollowPlayerAcrossTeleport = 0xED2; // 
            public const nint m_flWidth = 0xED4; // 
            public const nint m_flHeight = 0xED8; // 
            public const nint m_flDPI = 0xEDC; // 
            public const nint m_flInteractDistance = 0xEE0; // 
            public const nint m_flDepthOffset = 0xEE4; // 
            public const nint m_unOwnerContext = 0xEE8; // 
            public const nint m_unHorizontalAlign = 0xEEC; // 
            public const nint m_unVerticalAlign = 0xEF0; // 
            public const nint m_unOrientation = 0xEF4; // 
            public const nint m_bAllowInteractionFromAllSceneWorlds = 0xEF8; // 
            public const nint m_vecCSSClasses = 0xF00; // C_NetworkUtlVectorBase<CUtlSymbolLarge>
            public const nint m_bOpaque = 0xF18; // 
            public const nint m_bNoDepth = 0xF19; // 
            public const nint m_bRenderBackface = 0xF1A; // 
            public const nint m_bUseOffScreenIndicator = 0xF1B; // 
            public const nint m_bExcludeFromSaveGames = 0xF1C; // 
            public const nint m_bGrabbable = 0xF1D; // 
            public const nint m_bOnlyRenderToTexture = 0xF1E; // 
            public const nint m_bDisableMipGen = 0xF1F; // 
            public const nint m_nExplicitImageLayout = 0xF20; // 
        }
        // Parent: C_BaseEntity
        // Field count: 0
        ...
        public static class C_Team {
            public const nint m_aPlayerControllers = 0x548; // 
            public const nint m_aPlayers = 0x560; // 
            public const nint m_iScore = 0x578; // 
            public const nint m_szTeamname = 0x57C; // 
        }
        // Parent: C_SoundAreaEntityBase
        // Field count: 2
        //
        ...
        public static class C_SoundAreaEntityOrientedBox {
            public const nint m_vMin = 0x570; // 
            public const nint m_vMax = 0x57C; // 
        }
        // Parent: C_BaseModelEntity
        // Field count: 8
        //
        ...
        public static class C_TextureBasedAnimatable {
            public const nint m_bLoop = 0xCC8; // 
            public const nint m_flFPS = 0xCCC; // 
            public const nint m_hPositionKeys = 0xCD0; // 
            public const nint m_hRotationKeys = 0xCD8; // 
            public const nint m_vAnimationBoundsMin = 0xCE0; // 
            public const nint m_vAnimationBoundsMax = 0xCEC; // 
            public const nint m_flStartTime = 0xCF8; // 
            public const nint m_flStartFrame = 0xCFC; // 
        }
        ...
        public static class CSkyboxReference {
            public const nint m_worldGroupId = 0x548; // 
            public const nint m_hSkyCamera = 0x54C; // 
        }
        ...
        public static class C_CSGOViewModel {
            public const nint m_bShouldIgnoreOffsetAndAccuracy = 0xF68; // 
            public const nint m_nWeaponParity = 0xF6C; // 
            public const nint m_nOldWeaponParity = 0xF70; // 
            public const nint m_nLastKnownAssociatedWeaponEntIndex = 0xF74; // 
            public const nint m_bNeedToQueueHighResComposite = 0xF78; // 
            public const nint m_vLoweredWeaponOffset = 0xFC8; // 
        }
        // Parent: CEntityComponent
        // Field count: 1
        ...
        public static class C_EnvLightProbeVolume {
            public const nint m_Entity_hLightProbeTexture = 0x1528; // 
            public const nint m_Entity_hLightProbeDirectLightIndicesTexture = 0x1530; // 
            public const nint m_Entity_hLightProbeDirectLightScalarsTexture = 0x1538; // 
            public const nint m_Entity_hLightProbeDirectLightShadowsTexture = 0x1540; // 
            public const nint m_Entity_vBoxMins = 0x1548; // 
            public const nint m_Entity_vBoxMaxs = 0x1554; // 
            public const nint m_Entity_bMoveable = 0x1560; // 
            public const nint m_Entity_nHandshake = 0x1564; // 
            public const nint m_Entity_nPriority = 0x1568; // 
            public const nint m_Entity_bStartDisabled = 0x156C; // 
            public const nint m_Entity_nLightProbeSizeX = 0x1570; // 
            public const nint m_Entity_nLightProbeSizeY = 0x1574; // 
            public const nint m_Entity_nLightProbeSizeZ = 0x1578; // 
            public const nint m_Entity_nLightProbeAtlasX = 0x157C; // 
            public const nint m_Entity_nLightProbeAtlasY = 0x1580; // 
            public const nint m_Entity_nLightProbeAtlasZ = 0x1584; // 
            public const nint m_Entity_bEnabled = 0x1591; // 
        }
        // Parent: CBaseAnimGraph
        // Field count: 1
        public static class C_ViewmodelAttachmentModel {
            public const nint m_bShouldFrontFaceCullLeftHanded = 0xED0; // 
        }
        // Parent: None
        // Field count: 0
        //
        ...
        public static class C_TeamRoundTimer {
            public const nint m_bTimerPaused = 0x548; // 
            public const nint m_flTimeRemaining = 0x54C; // 
            public const nint m_flTimerEndTime = 0x550; // 
            public const nint m_bIsDisabled = 0x554; // 
            public const nint m_bShowInHUD = 0x555; // 
            public const nint m_nTimerLength = 0x558; // 
            public const nint m_nTimerInitialLength = 0x55C; // 
            public const nint m_nTimerMaxLength = 0x560; // 
            public const nint m_bAutoCountdown = 0x564; // 
            public const nint m_nSetupTimeLength = 0x568; // 
            public const nint m_nState = 0x56C; // 
            public const nint m_bStartPaused = 0x570; // 
            public const nint m_bInCaptureWatchState = 0x571; // 
            public const nint m_flTotalTime = 0x574; // 
            public const nint m_bStopWatchTimer = 0x578; // 
            public const nint m_bFireFinished = 0x579; // 
            public const nint m_bFire5MinRemain = 0x57A; // 
            public const nint m_bFire4MinRemain = 0x57B; // 
            public const nint m_bFire3MinRemain = 0x57C; // 
            public const nint m_bFire2MinRemain = 0x57D; // 
            public const nint m_bFire1MinRemain = 0x57E; // 
            public const nint m_bFire30SecRemain = 0x57F; // 
            public const nint m_bFire10SecRemain = 0x580; // 
            public const nint m_bFire5SecRemain = 0x581; // 
            public const nint m_bFire4SecRemain = 0x582; // 
            public const nint m_bFire3SecRemain = 0x583; // 
            public const nint m_bFire2SecRemain = 0x584; // 
            public const nint m_bFire1SecRemain = 0x585; // 
            public const nint m_nOldTimerLength = 0x588; // 
            public const nint m_nOldTimerState = 0x58C; // 
        }
        // Parent: None
        // Field count: 2
        //
        ...
        public static class CPathSimple {
            public const nint m_pathString = 0x598; // 
        }
        ...
        public static class CPointOffScreenIndicatorUi {
            public const nint m_bBeenEnabled = 0xF30; // 
            public const nint m_bHide = 0xF31; // 
            public const nint m_flSeenTargetTime = 0xF34; // 
            public const nint m_pTargetPanel = 0xF38; // 
        }
        // Parent: None
        // Field count: 0
        //
        ...
        public static class C_CSWeaponBaseGun {
            public const nint m_zoomLevel = 0x1A70; // 
            public const nint m_iBurstShotsRemaining = 0x1A74; // 
            public const nint m_iSilencerBodygroup = 0x1A78; // 
            public const nint m_silencedModelIndex = 0x1A88; // 
            public const nint m_inPrecache = 0x1A8C; // 
            public const nint m_bNeedsBoltAction = 0x1A8D; // 
        }
        // Parent: C_BaseEntity
        // Field count: 4
        //
        ...
        public static class C_SkyCamera {
            public const nint m_skyboxData = 0x548; // 
            public const nint m_skyboxSlotToken = 0x5D8; // 
            public const nint m_bUseAngles = 0x5DC; // 
            public const nint m_pNext = 0x5E0; // 
        }
        // Parent: C_BaseModelEntity
        // Field count: 0
        ...
        public static class C_EntityDissolve {
            public const nint m_flStartTime = 0xCD0; // 
            public const nint m_flFadeInStart = 0xCD4; // 
            public const nint m_flFadeInLength = 0xCD8; // 
            public const nint m_flFadeOutModelStart = 0xCDC; // 
            public const nint m_flFadeOutModelLength = 0xCE0; // 
            public const nint m_flFadeOutStart = 0xCE4; // 
            public const nint m_flFadeOutLength = 0xCE8; // 
            public const nint m_flNextSparkTime = 0xCEC; // 
            public const nint m_nDissolveType = 0xCF0; // 
            public const nint m_vDissolverOrigin = 0xCF4; // 
            public const nint m_nMagnitude = 0xD00; // 
            public const nint m_bCoreExplode = 0xD04; // 
            public const nint m_bLinkedToServerEnt = 0xD05; // 
        }
        ...
        public static class C_CSPlayerPawnBase {
            public const nint m_pPingServices = 0x12B0; // 
            public const nint m_pViewModelServices = 0x12B8; // 
            public const nint m_fRenderingClipPlane = 0x12C0; // 
            public const nint m_nLastClipPlaneSetupFrame = 0x12D0; // 
            public const nint m_vecLastClipCameraPos = 0x12D4; // 
            public const nint m_vecLastClipCameraForward = 0x12E0; // 
            public const nint m_bClipHitStaticWorld = 0x12EC; // 
            public const nint m_bCachedPlaneIsValid = 0x12ED; // 
            public const nint m_pClippingWeapon = 0x12F0; // 
            public const nint m_previousPlayerState = 0x12F8; // 
            public const nint m_iPlayerState = 0x12FC; // 
            public const nint m_bIsRescuing = 0x1300; // 
            public const nint m_fImmuneToGunGameDamageTime = 0x1304; // 
            public const nint m_fImmuneToGunGameDamageTimeLast = 0x1308; // 
            public const nint m_bGunGameImmunity = 0x130C; // 
            public const nint m_bHasMovedSinceSpawn = 0x130D; // 
            public const nint m_fMolotovUseTime = 0x1310; // 
            public const nint m_fMolotovDamageTime = 0x1314; // 
            public const nint m_iThrowGrenadeCounter = 0x1318; // 
            public const nint m_flLastSpawnTimeIndex = 0x131C; // 
            public const nint m_iProgressBarDuration = 0x1320; // 
            public const nint m_flProgressBarStartTime = 0x1324; // 
            public const nint m_vecIntroStartEyePosition = 0x1328; // 
            public const nint m_vecIntroStartPlayerForward = 0x1334; // 
            public const nint m_flClientDeathTime = 0x1340; // 
            public const nint m_bScreenTearFrameCaptured = 0x1344; // 
            public const nint m_flFlashBangTime = 0x1348; // 
            public const nint m_flFlashScreenshotAlpha = 0x134C; // 
            public const nint m_flFlashOverlayAlpha = 0x1350; // 
            public const nint m_bFlashBuildUp = 0x1354; // 
            public const nint m_bFlashDspHasBeenCleared = 0x1355; // 
            public const nint m_bFlashScreenshotHasBeenGrabbed = 0x1356; // 
            public const nint m_flFlashMaxAlpha = 0x1358; // 
            public const nint m_flFlashDuration = 0x135C; // 
            public const nint m_iHealthBarRenderMaskIndex = 0x1360; // 
            public const nint m_flHealthFadeValue = 0x1364; // 
            public const nint m_flHealthFadeAlpha = 0x1368; // 
            public const nint m_flDeathCCWeight = 0x1378; // 
            public const nint m_flPrevRoundEndTime = 0x137C; // 
            public const nint m_flPrevMatchEndTime = 0x1380; // 
            public const nint m_angEyeAngles = 0x1388; // 
            public const nint m_fNextThinkPushAway = 0x13A0; // 
            public const nint m_bShouldAutobuyDMWeapons = 0x13A4; // 
            public const nint m_bShouldAutobuyNow = 0x13A5; // 
            public const nint m_iIDEntIndex = 0x13A8; // 
            public const nint m_delayTargetIDTimer = 0x13B0; // 
            public const nint m_iTargetItemEntIdx = 0x13C8; // 
            public const nint m_iOldIDEntIndex = 0x13CC; // 
            public const nint m_holdTargetIDTimer = 0x13D0; // 
            public const nint m_flCurrentMusicStartTime = 0x13EC; // 
            public const nint m_flMusicRoundStartTime = 0x13F0; // 
            public const nint m_bDeferStartMusicOnWarmup = 0x13F4; // 
            public const nint m_cycleLatch = 0x13F8; // 
            public const nint m_serverIntendedCycle = 0x13FC; // 
            public const nint m_flLastSmokeOverlayAlpha = 0x1400; // 
            public const nint m_flLastSmokeAge = 0x1404; // 
            public const nint m_vLastSmokeOverlayColor = 0x1408; // 
            public const nint m_nPlayerSmokedFx = 0x1414; // 
            public const nint m_nPlayerInfernoBodyFx = 0x1418; // 
            public const nint m_nPlayerInfernoFootFx = 0x141C; // 
            public const nint m_flNextMagDropTime = 0x1420; // 
            public const nint m_nLastMagDropAttachmentIndex = 0x1424; // 
            public const nint m_vecLastAliveLocalVelocity = 0x1428; // 
            public const nint m_bGuardianShouldSprayCustomXMark = 0x1450; // 
            public const nint m_hOriginalController = 0x1458; // 
        }
        ...
        public static class C_PostProcessingVolume {
            public const nint m_hPostSettings = 0xCE0; // 
            public const nint m_flFadeDuration = 0xCE8; // 
            public const nint m_flMinLogExposure = 0xCEC; // 
            public const nint m_flMaxLogExposure = 0xCF0; // 
            public const nint m_flMinExposure = 0xCF4; // 
            public const nint m_flMaxExposure = 0xCF8; // 
            public const nint m_flExposureCompensation = 0xCFC; // 
            public const nint m_flExposureFadeSpeedUp = 0xD00; // 
            public const nint m_flExposureFadeSpeedDown = 0xD04; // 
            public const nint m_flTonemapEVSmoothingRange = 0xD08; // 
            public const nint m_bMaster = 0xD0C; // 
            public const nint m_bExposureControl = 0xD0D; // 
            public const nint m_flRate = 0xD10; // 
            public const nint m_flTonemapPercentTarget = 0xD14; // 
            public const nint m_flTonemapPercentBrightPixels = 0xD18; // 
            public const nint m_flTonemapMinAvgLum = 0xD1C; // 
        }
        // Parent: CPlayerPawnComponent
        // Field count: 1
        //
        ...
        public static class C_BaseFire {
            public const nint m_flScale = 0x548; // 
            public const nint m_flStartScale = 0x54C; // 
            public const nint m_flScaleTime = 0x550; // 
            public const nint m_nFlags = 0x554; // 
        }
        // Parent: C_BaseEntity
        // Field count: 16
        //
        ...
        public static class CBasePlayerController {
            public const nint m_nFinalPredictedTick = 0x550; // 
            public const nint m_CommandContext = 0x558; // 
            public const nint m_nInButtonsWhichAreToggles = 0x5F0; // 
            public const nint m_nTickBase = 0x5F8; // 
            public const nint m_hPawn = 0x5FC; // 
            public const nint m_bKnownTeamMismatch = 0x600; // 
            public const nint m_hPredictedPawn = 0x604; // 
            public const nint m_nSplitScreenSlot = 0x608; // 
            public const nint m_hSplitOwner = 0x60C; // 
            public const nint m_hSplitScreenPlayers = 0x610; // 
            public const nint m_bIsHLTV = 0x628; // 
            public const nint m_iConnected = 0x62C; // 
            public const nint m_iszPlayerName = 0x630; // 
            public const nint m_steamID = 0x6B8; // 
            public const nint m_bIsLocalPlayerController = 0x6C0; // 
            public const nint m_iDesiredFOV = 0x6C4; // 
        }
        // Parent: None
        // Field count: 0
        //
        ...
        public static class C_DecoyProjectile {
            public const nint m_nDecoyShotTick = 0x1150; // 
            public const nint m_nClientLastKnownDecoyShotTick = 0x1154; // 
            public const nint m_flTimeParticleEffectSpawn = 0x1178; // 
        }
        // Parent: CBaseAnimGraph
        // Field count: 0
        ...
        public static class C_CSGO_PreviewPlayer {
            public const nint m_animgraph = 0x2368; // 
            public const nint m_animgraphCharacterModeString = 0x2370; // 
            public const nint m_flInitialModelScale = 0x2378; // 
        }
        ...
        public static class C_C4 {
            public const nint m_szScreenText = 0x1A70; // 
            public const nint m_activeLightParticleIndex = 0x1A90; // 
            public const nint m_eActiveLightEffect = 0x1A94; // 
            public const nint m_bStartedArming = 0x1A98; // 
            public const nint m_fArmedTime = 0x1A9C; // 
            public const nint m_bBombPlacedAnimation = 0x1AA0; // 
            public const nint m_bIsPlantingViaUse = 0x1AA1; // 
            public const nint m_entitySpottedState = 0x1AA8; // 
            public const nint m_nSpotRules = 0x1AC0; // 
            public const nint m_bPlayedArmingBeeps = 0x1AC4; // 
            public const nint m_bBombPlanted = 0x1ACB; // 
        }
        // Parent: C_BaseModelEntity
        // Field count: 13
        //
        ...
        public static class CBaseAnimGraph {
            public const nint m_bInitiallyPopulateInterpHistory = 0xD40; // 
            public const nint m_bSuppressAnimEventSounds = 0xD42; // 
            public const nint m_bAnimGraphUpdateEnabled = 0xD50; // 
            public const nint m_flMaxSlopeDistance = 0xD54; // 
            public const nint m_vLastSlopeCheckPos = 0xD58; // 
            public const nint m_bAnimationUpdateScheduled = 0xD64; // 
            public const nint m_vecForce = 0xD68; // 
            public const nint m_nForceBone = 0xD74; // 
            public const nint m_pClientsideRagdoll = 0xD78; // 
            public const nint m_bBuiltRagdoll = 0xD80; // 
            public const nint m_pRagdollPose = 0xD98; // 
            public const nint m_bRagdollClientSide = 0xDA0; // 
            public const nint m_bHasAnimatedMaterialAttributes = 0xDB0; // 
        }
        // Parent: C_CSWeaponBase
        // Field count: 0
        ...
        public static class C_PathParticleRope {
            public const nint m_bStartActive = 0x548; // 
            public const nint m_flMaxSimulationTime = 0x54C; // 
            public const nint m_iszEffectName = 0x550; // 
            public const nint m_PathNodes_Name = 0x558; // 
            public const nint m_flParticleSpacing = 0x570; // 
            public const nint m_flSlack = 0x574; // 
            public const nint m_flRadius = 0x578; // 
            public const nint m_ColorTint = 0x57C; // 
            public const nint m_nEffectState = 0x580; // 
            public const nint m_iEffectIndex = 0x588; // 
            public const nint m_PathNodes_Position = 0x590; // 
            public const nint m_PathNodes_TangentIn = 0x5A8; // 
            public const nint m_PathNodes_TangentOut = 0x5C0; // 
            public const nint m_PathNodes_Color = 0x5D8; // 
            public const nint m_PathNodes_PinEnabled = 0x5F0; // 
            public const nint m_PathNodes_RadiusScale = 0x608; // 
        }
        // Parent: None
        // Field count: 0
        //
        ...
        public static class C_BasePlayerWeapon {
            public const nint m_nNextPrimaryAttackTick = 0x15B0; // 
            public const nint m_flNextPrimaryAttackTickRatio = 0x15B4; // 
            public const nint m_nNextSecondaryAttackTick = 0x15B8; // 
            public const nint m_flNextSecondaryAttackTickRatio = 0x15BC; // 
            public const nint m_iClip1 = 0x15C0; // 
            public const nint m_iClip2 = 0x15C4; // 
            public const nint m_pReserveAmmo = 0x15C8; // 
        }
        ...
        public static class C_Fish {
            public const nint m_pos = 0xED0; // 
            public const nint m_vel = 0xEDC; // 
            public const nint m_angles = 0xEE8; // 
            public const nint m_localLifeState = 0xEF4; // 
            public const nint m_deathDepth = 0xEF8; // 
            public const nint m_deathAngle = 0xEFC; // 
            public const nint m_buoyancy = 0xF00; // 
            public const nint m_wiggleTimer = 0xF08; // 
            public const nint m_wigglePhase = 0xF20; // 
            public const nint m_wiggleRate = 0xF24; // 
            public const nint m_actualPos = 0xF28; // 
            public const nint m_actualAngles = 0xF34; // 
            public const nint m_poolOrigin = 0xF40; // 
            public const nint m_waterLevel = 0xF4C; // 
            public const nint m_gotUpdate = 0xF50; // 
            public const nint m_x = 0xF54; // 
            public const nint m_y = 0xF58; // 
            public const nint m_z = 0xF5C; // 
            public const nint m_angle = 0xF60; // 
            public const nint m_errorHistory = 0xF64; // 
            public const nint m_errorHistoryIndex = 0xFB4; // 
            public const nint m_errorHistoryCount = 0xFB8; // 
            public const nint m_averageError = 0xFBC; // 
        }
        ...
        public static class C_BasePlayerPawn {
            public const nint m_pWeaponServices = 0x10F8; // 
            public const nint m_pItemServices = 0x1100; // 
            public const nint m_pAutoaimServices = 0x1108; // 
            public const nint m_pObserverServices = 0x1110; // 
            public const nint m_pWaterServices = 0x1118; // 
            public const nint m_pUseServices = 0x1120; // 
            public const nint m_pFlashlightServices = 0x1128; // 
            public const nint m_pCameraServices = 0x1130; // 
            public const nint m_pMovementServices = 0x1138; // 
            public const nint m_ServerViewAngleChanges = 0x1148; // 
            public const nint m_nHighestConsumedServerViewAngleChangeIndex = 0x1198; // 
            public const nint v_angle = 0x119C; // 
            public const nint v_anglePrevious = 0x11A8; // 
            public const nint m_iHideHUD = 0x11B4; // 
            public const nint m_skybox3d = 0x11B8; // 
            public const nint m_flDeathTime = 0x1248; // 
            public const nint m_vecPredictionError = 0x124C; // 
            public const nint m_flPredictionErrorTime = 0x1258; // 
            public const nint m_vecLastCameraSetupLocalOrigin = 0x125C; // 
            public const nint m_flLastCameraSetupTime = 0x1268; // 
            public const nint m_flFOVSensitivityAdjust = 0x126C; // 
            public const nint m_flMouseSensitivity = 0x1270; // 
            public const nint m_vOldOrigin = 0x1274; // 
            public const nint m_flOldSimulationTime = 0x1280; // 
            public const nint m_nLastExecutedCommandNumber = 0x1284; // 
            public const nint m_nLastExecutedCommandTick = 0x1288; // 
            public const nint m_hController = 0x128C; // 
            public const nint m_bIsSwappingToPredictableController = 0x1290; // 
        }
        // Parent: None
        // Field count: 6
        //
        ...
        public static class C_TriggerBuoyancy {
            public const nint m_BuoyancyHelper = 0xCD0; // 
            public const nint m_flFluidDensity = 0xCF0; // 
        }
        // Parent: C_BaseModelEntity
        // Field count: 41
        //
        ...
        public static class C_RopeKeyframe {
            public const nint m_LinksTouchingSomething = 0xCD0; // 
            public const nint m_nLinksTouchingSomething = 0xCD4; // 
            public const nint m_bApplyWind = 0xCD8; // 
            public const nint m_fPrevLockedPoints = 0xCDC; // 
            public const nint m_iForcePointMoveCounter = 0xCE0; // 
            public const nint m_bPrevEndPointPos = 0xCE4; // 
            public const nint m_vPrevEndPointPos = 0xCE8; // 
            public const nint m_flCurScroll = 0xD00; // 
            public const nint m_flScrollSpeed = 0xD04; // 
            public const nint m_RopeFlags = 0xD08; // 
            public const nint m_iRopeMaterialModelIndex = 0xD10; // CStrongHandle<InfoForResourceTypeIMaterial2>
            public const nint m_LightValues = 0xF88; // 
            public const nint m_nSegments = 0x1000; // 
            public const nint m_hStartPoint = 0x1004; // 
            public const nint m_hEndPoint = 0x1008; // 
            public const nint m_iStartAttachment = 0x100C; // 
            public const nint m_iEndAttachment = 0x100D; // 
            public const nint m_Subdiv = 0x100E; // 
            public const nint m_RopeLength = 0x1010; // 
            public const nint m_Slack = 0x1012; // 
            public const nint m_TextureScale = 0x1014; // 
            public const nint m_fLockedPoints = 0x1018; // 
            public const nint m_nChangeCount = 0x1019; // 
            public const nint m_Width = 0x101C; // 
            ...
            public const nint m_TextureHeight = 0x1038; // 
            public const nint m_vecImpulse = 0x103C; // 
            public const nint m_vecPreviousImpulse = 0x1048; // 
            public const nint m_flCurrentGustTimer = 0x1054; // 
            public const nint m_flCurrentGustLifetime = 0x1058; // 
            public const nint m_flTimeToNextGust = 0x105C; // 
            public const nint m_vWindDir = 0x1060; // 
            public const nint m_vColorMod = 0x106C; // 
            public const nint m_vCachedEndPointAttachmentPos = 0x1078; // 
            public const nint m_vCachedEndPointAttachmentAngle = 0x1090; // 
            public const nint m_bConstrainBetweenEndpoints = 0x10A8; // 
        ...
        public static class C_GradientFog {
            public const nint m_hGradientFogTexture = 0x548; // 
            public const nint m_flFogStartDistance = 0x550; // 
            public const nint m_flFogEndDistance = 0x554; // 
            public const nint m_bHeightFogEnabled = 0x558; // 
            public const nint m_flFogStartHeight = 0x55C; // 
            public const nint m_flFogEndHeight = 0x560; // 
            public const nint m_flFarZ = 0x564; // 
            public const nint m_flFogMaxOpacity = 0x568; // 
            public const nint m_flFogFalloffExponent = 0x56C; // 
            public const nint m_flFogVerticalExponent = 0x570; // 
            public const nint m_fogColor = 0x574; // 
            public const nint m_flFogStrength = 0x578; // 
            public const nint m_flFadeTime = 0x57C; // 
            public const nint m_bStartDisabled = 0x580; // 
            public const nint m_bIsEnabled = 0x581; // 
            public const nint m_bGradientFogNeedsTextures = 0x582; // 
        }
        // Parent: None
        // Field count: 2
        //
        ...
        public static class C_CSGO_TeamPreviewCamera {
            public const nint m_nVariant = 0x5B0; // 
            public const nint m_bDofEnabled = 0x5B4; // 
            public const nint m_flDofNearBlurry = 0x5B8; // 
            public const nint m_flDofNearCrisp = 0x5BC; // 
            public const nint m_flDofFarCrisp = 0x5C0; // 
            public const nint m_flDofFarBlurry = 0x5C4; // 
            public const nint m_flDofTiltToGround = 0x5C8; // 
        }
        ...
        public static class C_EconWearable {
            public const nint m_nForceSkin = 0x15B0; // 
            public const nint m_bAlwaysAllow = 0x15B4; // 
        }
        ...
        public static class C_EnvVolumetricFogVolume {
            public const nint m_bActive = 0x548; // 
            public const nint m_vBoxMins = 0x54C; // 
            public const nint m_vBoxMaxs = 0x558; // 
            public const nint m_bStartDisabled = 0x564; // 
            public const nint m_flStrength = 0x568; // 
            public const nint m_nFalloffShape = 0x56C; // 
            public const nint m_flFalloffExponent = 0x570; // 
            public const nint m_flHeightFogDepth = 0x574; // 
            public const nint m_fHeightFogEdgeWidth = 0x578; // 
            public const nint m_fIndirectLightStrength = 0x57C; // 
            public const nint m_fSunLightStrength = 0x580; // 
            public const nint m_fNoiseStrength = 0x584; // 
            public const nint m_bOverrideIndirectLightStrength = 0x588; // 
            public const nint m_bOverrideSunLightStrength = 0x589; // 
            public const nint m_bOverrideNoiseStrength = 0x58A; // 
        }
        // Parent: C_BaseModelEntity
        // Field count: 0
        ...
        public static class C_FireSmoke {
            public const nint m_nFlameModelIndex = 0x558; // 
            public const nint m_nFlameFromAboveModelIndex = 0x55C; // 
            public const nint m_flScaleRegister = 0x560; // 
            public const nint m_flScaleStart = 0x564; // 
            public const nint m_flScaleEnd = 0x568; // 
            public const nint m_flScaleTimeStart = 0x56C; // 
            public const nint m_flScaleTimeEnd = 0x570; // 
            public const nint m_flChildFlameSpread = 0x574; // 
            public const nint m_flClipPerc = 0x588; // 
            public const nint m_bClipTested = 0x58C; // 
            public const nint m_bFadingOut = 0x58D; // 
            public const nint m_tParticleSpawn = 0x590; // 
            public const nint m_pFireOverlay = 0x598; // 
        }
        // Parent: C_CSWeaponBaseGun
        // Field count: 0
        ...
        public static class C_EnvCombinedLightProbeVolume {
            public const nint m_Entity_Color = 0x15A8; // 
            public const nint m_Entity_flBrightness = 0x15AC; // 
            public const nint m_Entity_hCubemapTexture = 0x15B0; // 
            public const nint m_Entity_bCustomCubemapTexture = 0x15B8; // 
            public const nint m_Entity_hLightProbeTexture = 0x15C0; // 
            public const nint m_Entity_hLightProbeDirectLightIndicesTexture = 0x15C8; // 
            public const nint m_Entity_hLightProbeDirectLightScalarsTexture = 0x15D0; // 
            public const nint m_Entity_hLightProbeDirectLightShadowsTexture = 0x15D8; // 
            public const nint m_Entity_vBoxMins = 0x15E0; // 
            public const nint m_Entity_vBoxMaxs = 0x15EC; // 
            public const nint m_Entity_bMoveable = 0x15F8; // 
            public const nint m_Entity_nHandshake = 0x15FC; // 
            public const nint m_Entity_nEnvCubeMapArrayIndex = 0x1600; // 
            public const nint m_Entity_nPriority = 0x1604; // 
            public const nint m_Entity_bStartDisabled = 0x1608; // 
            public const nint m_Entity_flEdgeFadeDist = 0x160C; // 
            public const nint m_Entity_vEdgeFadeDists = 0x1610; // 
            public const nint m_Entity_nLightProbeSizeX = 0x161C; // 
            public const nint m_Entity_nLightProbeSizeY = 0x1620; // 
            public const nint m_Entity_nLightProbeSizeZ = 0x1624; // 
            public const nint m_Entity_nLightProbeAtlasX = 0x1628; // 
            public const nint m_Entity_nLightProbeAtlasY = 0x162C; // 
            public const nint m_Entity_nLightProbeAtlasZ = 0x1630; // 
            public const nint m_Entity_bEnabled = 0x1649; // 
        }
        // Parent: C_SoundOpvarSetPointBase
        // Field count: 0
        ...
        public static class CLogicRelay {
            public const nint m_OnTrigger = 0x548; // 
            public const nint m_OnSpawn = 0x570; // 
            public const nint m_bDisabled = 0x598; // 
            public const nint m_bWaitForRefire = 0x599; // 
            public const nint m_bTriggerOnce = 0x59A; // 
            public const nint m_bFastRetrigger = 0x59B; // 
            public const nint m_bPassthoughCaller = 0x59C; // 
        }
        // Parent: C_PointCamera
        // Field count: 1
        public static class C_PointCameraVFOV {
            public const nint m_flVerticalFOV = 0x5A8; // 
        }
        ...
        public static class C_BarnLight {
            ...
            public const nint m_nColorMode = 0xCCC; // 
            public const nint m_Color = 0xCD0; // 
            public const nint m_flColorTemperature = 0xCD4; // 
            public const nint m_flBrightness = 0xCD8; // 
            public const nint m_flBrightnessScale = 0xCDC; // 
            public const nint m_nDirectLight = 0xCE0; // 
            public const nint m_nBakedShadowIndex = 0xCE4; // 
            public const nint m_nLuminaireShape = 0xCE8; // 
            public const nint m_flLuminaireSize = 0xCEC; // 
            public const nint m_flLuminaireAnisotropy = 0xCF0; // 
            public const nint m_LightStyleString = 0xCF8; // 
            public const nint m_flLightStyleStartTime = 0xD00; // 
            ...
            public const nint m_LightStyleTargets = 0xD38; // 
            public const nint m_StyleEvent = 0xD50; // 
            public const nint m_hLightCookie = 0xDF0; // 
            public const nint m_flShape = 0xDF8; // 
            public const nint m_flSoftX = 0xDFC; // 
            public const nint m_flSoftY = 0xE00; // 
            public const nint m_flSkirt = 0xE04; // 
            public const nint m_flSkirtNear = 0xE08; // 
            public const nint m_vSizeParams = 0xE0C; // 
            public const nint m_flRange = 0xE18; // 
            public const nint m_vShear = 0xE1C; // 
            public const nint m_nBakeSpecularToCubemaps = 0xE28; // 
            public const nint m_vBakeSpecularToCubemapsSize = 0xE2C; // 
            public const nint m_nCastShadows = 0xE38; // 
            public const nint m_nShadowMapSize = 0xE3C; // 
            public const nint m_nShadowPriority = 0xE40; // 
            public const nint m_bContactShadow = 0xE44; // 
            public const nint m_nBounceLight = 0xE48; // 
            public const nint m_flBounceScale = 0xE4C; // 
            public const nint m_flMinRoughness = 0xE50; // 
            public const nint m_vAlternateColor = 0xE54; // 
            public const nint m_fAlternateColorBrightness = 0xE60; // 
            public const nint m_nFog = 0xE64; // 
            public const nint m_flFogStrength = 0xE68; // 
            public const nint m_nFogShadows = 0xE6C; // 
            public const nint m_flFogScale = 0xE70; // 
            public const nint m_flFadeSizeStart = 0xE74; // 
            public const nint m_flFadeSizeEnd = 0xE78; // 
            public const nint m_flShadowFadeSizeStart = 0xE7C; // 
            public const nint m_flShadowFadeSizeEnd = 0xE80; // 
            public const nint m_bPrecomputedFieldsValid = 0xE84; // 
            public const nint m_vPrecomputedBoundsMins = 0xE88; // 
            public const nint m_vPrecomputedBoundsMaxs = 0xE94; // 
            public const nint m_vPrecomputedOBBOrigin = 0xEA0; // 
            public const nint m_vPrecomputedOBBAngles = 0xEAC; // 
            public const nint m_vPrecomputedOBBExtent = 0xEB8; // 
        }
        // Parent: C_BaseEntity
        // Field count: 8
        //
        ...
        public static class C_TonemapController2 {
            public const nint m_flAutoExposureMin = 0x548; // 
            public const nint m_flAutoExposureMax = 0x54C; // 
            public const nint m_flTonemapPercentTarget = 0x550; // 
            public const nint m_flTonemapPercentBrightPixels = 0x554; // 
            public const nint m_flTonemapMinAvgLum = 0x558; // 
            public const nint m_flExposureAdaptationSpeedUp = 0x55C; // 
            public const nint m_flExposureAdaptationSpeedDown = 0x560; // 
            public const nint m_flTonemapEVSmoothingRange = 0x564; // 
        }
        // Parent: C_CSWeaponBaseGun
        // Field count: 0
        ...
        public static class C_EconEntity {
            public const nint m_flFlexDelayTime = 0x1078; // 
            public const nint m_flFlexDelayedWeight = 0x1080; // 
            public const nint m_bAttributesInitialized = 0x1088; // 
            public const nint m_AttributeManager = 0x1090; // 
            public const nint m_OriginalOwnerXuidLow = 0x1538; // 
            public const nint m_OriginalOwnerXuidHigh = 0x153C; // 
            public const nint m_nFallbackPaintKit = 0x1540; // 
            public const nint m_nFallbackSeed = 0x1544; // 
            public const nint m_flFallbackWear = 0x1548; // 
            public const nint m_nFallbackStatTrak = 0x154C; // 
            public const nint m_bClientside = 0x1550; // 
            public const nint m_bParticleSystemsCreated = 0x1551; // 
            public const nint m_vecAttachedParticles = 0x1558; // 
            public const nint m_hViewmodelAttachment = 0x1570; // 
            public const nint m_iOldTeam = 0x1574; // 
            public const nint m_bAttachmentDirty = 0x1578; // 
            public const nint m_nUnloadedModelIndex = 0x157C; // 
            public const nint m_iNumOwnerValidationRetries = 0x1580; // 
            public const nint m_hOldProvidee = 0x1590; // 
        ...
        public static class C_ParticleSystem {
            public const nint m_szSnapshotFileName = 0xCC8; // 
            public const nint m_bActive = 0xEC8; // 
            public const nint m_bFrozen = 0xEC9; // 
            public const nint m_flFreezeTransitionDuration = 0xECC; // 
            public const nint m_nStopType = 0xED0; // 
            public const nint m_bAnimateDuringGameplayPause = 0xED4; // 
            public const nint m_iEffectIndex = 0xED8; // 
            public const nint m_flStartTime = 0xEE0; // 
            public const nint m_flPreSimTime = 0xEE4; // 
            public const nint m_vServerControlPoints = 0xEE8; // 
            public const nint m_iServerControlPointAssignments = 0xF18; // 
            public const nint m_hControlPointEnts = 0xF1C; // 
            public const nint m_bNoSave = 0x101C; // 
            public const nint m_bNoFreeze = 0x101D; // 
            public const nint m_bNoRamp = 0x101E; // 
            public const nint m_bStartActive = 0x101F; // 
            public const nint m_iszEffectName = 0x1020; // 
            public const nint m_iszControlPointNames = 0x1028; // 
            public const nint m_nDataCP = 0x1228; // 
            public const nint m_vecDataCPValue = 0x122C; // 
            public const nint m_nTintCP = 0x1238; // 
            public const nint m_clrTint = 0x123C; // 
            public const nint m_bOldActive = 0x1260; // 
            public const nint m_bOldFrozen = 0x1261; // 
        }
        ...
        public static class C_CSGameRulesProxy {
            public const nint m_pGameRules = 0x548; // 
        }
        // Parent: CPlayerPawnComponent
        // Field count: 6
        //
        ...
        public static class C_Multimeter {
            public const nint m_hTargetC4 = 0xED8; // 
        }
        // Parent: C_BaseEntity
        // Field count: 2
        public static class C_CsmFovOverride {
            public const nint m_cameraName = 0x548; // 
            public const nint m_flCsmFovOverrideValue = 0x550; // 
        }
        // Parent: C_BaseModelEntity
        // Field count: 9
        //
        ...
        public static class C_EnvDecal {
            ...
            public const nint m_flWidth = 0xCD0; // 
            public const nint m_flHeight = 0xCD4; // 
            public const nint m_flDepth = 0xCD8; // 
            public const nint m_nRenderOrder = 0xCDC; // 
            public const nint m_bProjectOnWorld = 0xCE0; // 
            public const nint m_bProjectOnCharacters = 0xCE1; // 
            public const nint m_bProjectOnWater = 0xCE2; // 
            public const nint m_flDepthSortBias = 0xCE4; // 
        }
        // Parent: CCSGameModeRules
        // Field count: 0
        ...
        public static class C_ColorCorrection {
            public const nint m_vecOrigin = 0x548; // 
            public const nint m_MinFalloff = 0x554; // 
            public const nint m_MaxFalloff = 0x558; // 
            public const nint m_flFadeInDuration = 0x55C; // 
            public const nint m_flFadeOutDuration = 0x560; // 
            public const nint m_flMaxWeight = 0x564; // 
            public const nint m_flCurWeight = 0x568; // 
            public const nint m_netlookupFilename = 0x56C; // 
            public const nint m_bEnabled = 0x76C; // 
            public const nint m_bMaster = 0x76D; // 
            public const nint m_bClientSide = 0x76E; // 
            public const nint m_bExclusive = 0x76F; // 
            public const nint m_bEnabledOnClient = 0x770; // 
            public const nint m_flCurWeightOnClient = 0x774; // 
            public const nint m_bFadingIn = 0x778; // 
            public const nint m_flFadeStartWeight = 0x77C; // 
            public const nint m_flFadeStartTime = 0x780; // 
            public const nint m_flFadeDuration = 0x784; // 
        }
        // Parent: C_BaseTrigger
        // Field count: 0
        ...
        public static class C_BaseDoor {
            public const nint m_bIsUsable = 0xCC8; // 
        }
        // Parent: C_BaseModelEntity
        // Field count: 2
        public static class CGrenadeTracer {
            public const nint m_flTracerDuration = 0xCE8; // 
            public const nint m_nType = 0xCEC; // 
        }
        // Parent: C_BaseTrigger
        // Field count: 1
        //
        ...
        public static class CBombTarget {
            public const nint m_bBombPlantedHere = 0xCD0; // 
        }
        // Parent: C_BaseClientUIEntity
        // Field count: 2
        //
        ...
        public static class C_PointClientUIDialog {
            public const nint m_hActivator = 0xCF8; // 
            public const nint m_bStartEnabled = 0xCFC; // 
        }
        // Parent: CCSGameModeRules
        // Field count: 1
        //
        ...
        public static class C_HandleTest {
            public const nint m_Handle = 0x548; // 
            public const nint m_bSendHandle = 0x54C; // 
        }
        // Parent: C_BaseEntity
        // Field count: 1
        //
        ...
        public static class C_WeaponShield {
            public const nint m_flDisplayHealth = 0x1A90; // 
        }
        // Parent: C_PointClientUIWorldPanel
        // Field count: 1
        //
        ...
        public static class C_PointClientUIWorldTextPanel {
            public const nint m_messageText = 0xF30; // 
        }
        // Parent: CPlayer_UseServices
        // Field count: 0
        ...
        public static class C_EnvParticleGlow {
            public const nint m_flAlphaScale = 0x1278; // 
            public const nint m_flRadiusScale = 0x127C; // 
            public const nint m_flSelfIllumScale = 0x1280; // 
            public const nint m_ColorTint = 0x1284; // 
            public const nint m_hTextureOverride = 0x1288; // 
        }
        // Parent: C_BaseEntity
        // Field count: 0
        ...
        public static class C_Sun {
            public const nint m_fxSSSunFlareEffectIndex = 0xCC8; // 
            public const nint m_fxSunFlareEffectIndex = 0xCCC; // 
            public const nint m_fdistNormalize = 0xCD0; // 
            public const nint m_vSunPos = 0xCD4; // 
            public const nint m_vDirection = 0xCE0; // 
            public const nint m_iszEffectName = 0xCF0; // 
            public const nint m_iszSSEffectName = 0xCF8; // 
            public const nint m_clrOverlay = 0xD00; // 
            public const nint m_bOn = 0xD04; // 
            public const nint m_bmaxColor = 0xD05; // 
            public const nint m_flSize = 0xD08; // 
            public const nint m_flHazeScale = 0xD0C; // 
            public const nint m_flRotation = 0xD10; // 
            public const nint m_flHDRColorScale = 0xD14; // 
            public const nint m_flAlphaHaze = 0xD18; // 
            public const nint m_flAlphaScale = 0xD1C; // 
            public const nint m_flAlphaHdr = 0xD20; // 
            public const nint m_flFarZScale = 0xD24; // 
        }
        // Parent: C_BaseEntity
        // Field count: 0
        ...
        public static class C_ColorCorrectionVolume {
            public const nint m_LastEnterWeight = 0xCD0; // 
            public const nint m_LastEnterTime = 0xCD4; // 
            public const nint m_LastExitWeight = 0xCD8; // 
            public const nint m_LastExitTime = 0xCDC; // 
            public const nint m_bEnabled = 0xCE0; // 
            public const nint m_MaxWeight = 0xCE4; // 
            public const nint m_FadeDuration = 0xCE8; // 
            public const nint m_Weight = 0xCEC; // 
            public const nint m_lookupFilename = 0xCF0; // 
        }
        // Parent: C_BaseModelEntity
        // Field count: 0
        ...
        public static class C_BulletHitModel {
            ...
            public const nint m_iBoneIndex = 0xF00; // 
            public const nint m_hPlayerParent = 0xF04; // 
            public const nint m_bIsHit = 0xF08; // 
            public const nint m_flTimeCreated = 0xF0C; // 
            public const nint m_vecStartPos = 0xF10; // 
        }
        // Parent: C_BaseEntity
        // Field count: 17
        //
        ...
        public static class C_MapVetoPickController {
            public const nint m_nDraftType = 0x558; // 
            public const nint m_nTeamWinningCoinToss = 0x55C; // 
            public const nint m_nTeamWithFirstChoice = 0x560; // 
            public const nint m_nVoteMapIdsList = 0x660; // 
            public const nint m_nAccountIDs = 0x67C; // 
            public const nint m_nMapId0 = 0x77C; // 
            public const nint m_nMapId1 = 0x87C; // 
            public const nint m_nMapId2 = 0x97C; // 
            public const nint m_nMapId3 = 0xA7C; // 
            public const nint m_nMapId4 = 0xB7C; // 
            public const nint m_nMapId5 = 0xC7C; // 
            public const nint m_nStartingSide0 = 0xD7C; // 
            public const nint m_nCurrentPhase = 0xE7C; // 
            public const nint m_nPhaseStartTick = 0xE80; // 
            public const nint m_nPhaseDurationTicks = 0xE84; // 
            public const nint m_nPostDataUpdateTick = 0xE88; // 
            public const nint m_bDisabledHud = 0xE8C; // 
        }
        // Parent: None
        // Field count: 0
        //
        ...
        public static class C_OmniLight {
            public const nint m_flInnerAngle = 0xF10; // 
            public const nint m_flOuterAngle = 0xF14; // 
            public const nint m_bShowLight = 0xF18; // 
        }
        // Parent: C_Inferno
        // Field count: 0
        ...
        public static class C_FuncLadder {
            public const nint m_vecLadderDir = 0xCC8; // 
            public const nint m_Dismounts = 0xCD8; // 
            public const nint m_vecLocalTop = 0xCF0; // 
            public const nint m_vecPlayerMountPositionTop = 0xCFC; // 
            public const nint m_vecPlayerMountPositionBottom = 0xD08; // 
            public const nint m_flAutoRideSpeed = 0xD14; // 
            public const nint m_bDisabled = 0xD18; // 
            public const nint m_bFakeLadder = 0xD19; // 
            public const nint m_bHasSlack = 0xD1A; // 
        }
        ...
        public static class C_BaseGrenade {
            public const nint m_bHasWarnedAI = 0x1068; // 
            public const nint m_bIsSmokeGrenade = 0x1069; // 
            public const nint m_bIsLive = 0x106A; // 
            public const nint m_DmgRadius = 0x106C; // 
            public const nint m_flDetonateTime = 0x1070; // 
            public const nint m_flWarnAITime = 0x1074; // 
            public const nint m_flDamage = 0x1078; // 
            public const nint m_iszBounceSound = 0x1080; // 
            public const nint m_ExplosionSound = 0x1088; // 
            public const nint m_hThrower = 0x1094; // 
            public const nint m_flNextAttack = 0x10AC; // 
            public const nint m_hOriginalThrower = 0x10B0; // 
        }
        // Parent: None
        // Field count: 1
        ...
        public static class C_EnvVolumetricFogController {
            public const nint m_flScattering = 0x548; // 
            public const nint m_flAnisotropy = 0x54C; // 
            public const nint m_flFadeSpeed = 0x550; // 
            public const nint m_flDrawDistance = 0x554; // 
            public const nint m_flFadeInStart = 0x558; // 
            public const nint m_flFadeInEnd = 0x55C; // 
            public const nint m_flIndirectStrength = 0x560; // 
            public const nint m_nIndirectTextureDimX = 0x564; // 
            public const nint m_nIndirectTextureDimY = 0x568; // 
            public const nint m_nIndirectTextureDimZ = 0x56C; // 
            public const nint m_vBoxMins = 0x570; // 
            public const nint m_vBoxMaxs = 0x57C; // 
            public const nint m_bActive = 0x588; // 
            public const nint m_flStartAnisoTime = 0x58C; // 
            public const nint m_flStartScatterTime = 0x590; // 
            public const nint m_flStartDrawDistanceTime = 0x594; // 
            public const nint m_flStartAnisotropy = 0x598; // 
            public const nint m_flStartScattering = 0x59C; // 
            public const nint m_flStartDrawDistance = 0x5A0; // 
            public const nint m_flDefaultAnisotropy = 0x5A4; // 
            public const nint m_flDefaultScattering = 0x5A8; // 
            public const nint m_flDefaultDrawDistance = 0x5AC; // 
            public const nint m_bStartDisabled = 0x5B0; // 
            public const nint m_bEnableIndirect = 0x5B1; // 
            public const nint m_bIndirectUseLPVs = 0x5B2; // 
            public const nint m_bIsMaster = 0x5B3; // 
            public const nint m_hFogIndirectTexture = 0x5B8; // 
            public const nint m_nForceRefreshCount = 0x5C0; // 
            public const nint m_fNoiseSpeed = 0x5C4; // 
            public const nint m_fNoiseStrength = 0x5C8; // 
            public const nint m_vNoiseScale = 0x5CC; // 
            public const nint m_bFirstTime = 0x5D8; // 
        }
        // Parent: C_CSWeaponBaseGun
        // Field count: 0
        ...
        public static class C_PointCommentaryNode {
            public const nint m_bActive = 0xED8; // 
            public const nint m_bWasActive = 0xED9; // 
            public const nint m_flEndTime = 0xEDC; // 
            public const nint m_flStartTime = 0xEE0; // 
            public const nint m_flStartTimeInCommentary = 0xEE4; // 
            public const nint m_iszCommentaryFile = 0xEE8; // 
            public const nint m_iszTitle = 0xEF0; // 
            public const nint m_iszSpeakers = 0xEF8; // 
            public const nint m_iNodeNumber = 0xF00; // 
            public const nint m_iNodeNumberMax = 0xF04; // 
            public const nint m_bListenedTo = 0xF08; // 
            public const nint m_hViewPosition = 0xF18; // 
            public const nint m_bRestartAfterRestore = 0xF1C; // 
        }
        // Parent: CCSPlayerBase_CameraServices
        // Field count: 0
        ...
        public static class C_InfoVisibilityBox {
            public const nint m_nMode = 0x54C; // 
            public const nint m_vBoxSize = 0x550; // 
            public const nint m_bEnabled = 0x55C; // 
        }
        // Parent: C_Sprite
        // Field count: 2
        public static class C_FireSprite {
            public const nint m_vecMoveDir = 0xDD8; // 
            public const nint m_bFadeFromAbove = 0xDE4; // 
        }
        // Parent: C_CSGO_TeamIntroCharacterPosition
        // Field count: 0
        ...
        public static class C_Precipitation {
            public const nint m_flDensity = 0xCD0; // 
            public const nint m_flParticleInnerDist = 0xCE0; // 
            public const nint m_pParticleDef = 0xCE8; // 
            public const nint m_tParticlePrecipTraceTimer = 0xD10; // 
            public const nint m_bActiveParticlePrecipEmitter = 0xD18; // 
            public const nint m_bParticlePrecipInitialized = 0xD19; // 
            public const nint m_bHasSimulatedSinceLastSceneObjectUpdate = 0xD1A; // 
            public const nint m_nAvailableSheetSequencesMaxIndex = 0xD1C; // 
        }
        // Parent: CEntitySubclassVDataBase
        // Field count: 7
        //
        ...
        public static class C_BaseClientUIEntity {
            public const nint m_bEnabled = 0xCD0; // 
            public const nint m_DialogXMLName = 0xCD8; // 
            public const nint m_PanelClassName = 0xCE0; // 
            public const nint m_PanelID = 0xCE8; // 
        }
        // Parent: C_BaseModelEntity
        // Field count: 3
        public static class C_FuncTrackTrain {
            public const nint m_nLongAxis = 0xCC8; // 
            public const nint m_flRadius = 0xCCC; // 
            public const nint m_flLineLength = 0xCD0; // 
        }
        // Parent: CPlayerPawnComponent
        // Field count: 4
        //
        ...
        public static class CBaseProp {
            public const nint m_bModelOverrodeBlockLOS = 0xED0; // 
            public const nint m_iShapeType = 0xED4; // 
            public const nint m_bConformToCollisionBounds = 0xED8; // 
            public const nint m_mPreferredCatchTransform = 0xEDC; // 
        }
        // Parent: C_CSGO_PreviewPlayer
        // Field count: 0
        ...
        public static class CPointTemplate {
            public const nint m_iszWorldName = 0x548; // 
            public const nint m_iszSource2EntityLumpName = 0x550; // 
            public const nint m_iszEntityFilterName = 0x558; // 
            public const nint m_flTimeoutInterval = 0x560; // 
            public const nint m_bAsynchronouslySpawnEntities = 0x564; // 
            public const nint m_pOutputOnSpawned = 0x568; // 
            ...
            public const nint m_createdSpawnGroupHandles = 0x598; // 
            public const nint m_SpawnedEntityHandles = 0x5B0; // 
            public const nint m_ScriptSpawnCallback = 0x5C8; // 
        ...
        public static class C_CSGO_PreviewModel {
            public const nint m_animgraph = 0x1068; // 
            public const nint m_animgraphCharacterModeString = 0x1070; // 
            public const nint m_defaultAnim = 0x1078; // 
            public const nint m_nDefaultAnimLoopMode = 0x1080; // 
            public const nint m_flInitialModelScale = 0x1084; // 
            public const nint m_sInitialWeaponState = 0x1088; // 
        }
        // Parent: C_PointEntity
        // Field count: 5
        public static class CInfoDynamicShadowHint {
            public const nint m_bDisabled = 0x548; // 
            public const nint m_flRange = 0x54C; // 
            public const nint m_nImportance = 0x550; // 
            public const nint m_nLightChoice = 0x554; // 
            public const nint m_hLight = 0x558; // 
        }
        // Parent: None
        // Field count: 0
        //
        ...
        public static class C_TriggerPhysics {
            public const nint m_gravityScale = 0xCD0; // 
            public const nint m_linearLimit = 0xCD4; // 
            public const nint m_linearDamping = 0xCD8; // 
            public const nint m_angularLimit = 0xCDC; // 
            public const nint m_angularDamping = 0xCE0; // 
            public const nint m_linearForce = 0xCE4; // 
            public const nint m_flFrequency = 0xCE8; // 
            public const nint m_flDampingRatio = 0xCEC; // 
            public const nint m_vecLinearForcePointAt = 0xCF0; // 
            public const nint m_bCollapseToForcePoint = 0xCFC; // 
            public const nint m_vecLinearForcePointAtWorld = 0xD00; // 
            public const nint m_vecLinearForceDirection = 0xD0C; // 
            public const nint m_bConvertToDebrisWhenPossible = 0xD18; // 
        }
        // Parent: CPlayerPawnComponent
        // Field count: 2
        //
        ...
        public static class C_EnvCubemap {
            public const nint m_Entity_hCubemapTexture = 0x5C8; // 
            public const nint m_Entity_bCustomCubemapTexture = 0x5D0; // 
            public const nint m_Entity_flInfluenceRadius = 0x5D4; // 
            public const nint m_Entity_vBoxProjectMins = 0x5D8; // 
            public const nint m_Entity_vBoxProjectMaxs = 0x5E4; // 
            public const nint m_Entity_bMoveable = 0x5F0; // 
            public const nint m_Entity_nHandshake = 0x5F4; // 
            public const nint m_Entity_nEnvCubeMapArrayIndex = 0x5F8; // 
            public const nint m_Entity_nPriority = 0x5FC; // 
            public const nint m_Entity_flEdgeFadeDist = 0x600; // 
            public const nint m_Entity_vEdgeFadeDists = 0x604; // 
            public const nint m_Entity_flDiffuseScale = 0x610; // 
            public const nint m_Entity_bStartDisabled = 0x614; // 
            public const nint m_Entity_bDefaultEnvMap = 0x615; // 
            public const nint m_Entity_bDefaultSpecEnvMap = 0x616; // 
            public const nint m_Entity_bIndoorCubeMap = 0x617; // 
            public const nint m_Entity_bCopyDiffuseFromDefaultCubemap = 0x618; // 
            public const nint m_Entity_bEnabled = 0x628; // 
        }
        // Parent: C_BaseViewModel
        // Field count: 3
        public static class C_PredictedViewModel {
            public const nint m_vPredictedLagOffset = 0xF38; // 
            public const nint m_targetSpeed = 0xF44; // 
            public const nint m_currentSpeed = 0xF50; // 
        }
        // Parent: C_CSWeaponBaseGun
        // Field count: 0
        ...
        public static class C_PointValueRemapper {
            public const nint m_bDisabled = 0x548; // 
            public const nint m_bDisabledOld = 0x549; // 
            public const nint m_bUpdateOnClient = 0x54A; // 
            public const nint m_nInputType = 0x54C; // 
            public const nint m_hRemapLineStart = 0x550; // 
            public const nint m_hRemapLineEnd = 0x554; // 
            public const nint m_flMaximumChangePerSecond = 0x558; // 
            public const nint m_flDisengageDistance = 0x55C; // 
            public const nint m_flEngageDistance = 0x560; // 
            public const nint m_bRequiresUseKey = 0x564; // 
            public const nint m_nOutputType = 0x568; // 
            public const nint m_hOutputEntities = 0x570; // 
            public const nint m_nHapticsType = 0x588; // 
            public const nint m_nMomentumType = 0x58C; // 
            public const nint m_flMomentumModifier = 0x590; // 
            public const nint m_flSnapValue = 0x594; // 
            public const nint m_flCurrentMomentum = 0x598; // 
            public const nint m_nRatchetType = 0x59C; // 
            public const nint m_flRatchetOffset = 0x5A0; // 
            public const nint m_flInputOffset = 0x5A4; // 
            public const nint m_bEngaged = 0x5A8; // 
            public const nint m_bFirstUpdate = 0x5A9; // 
            public const nint m_flPreviousValue = 0x5AC; // 
            public const nint m_flPreviousUpdateTickTime = 0x5B0; // 
            public const nint m_vecPreviousTestPoint = 0x5B4; // 
        }
        // Parent: C_CSWeaponBase
        // Field count: 0
        ...
        public static class C_ItemDogtags {
            public const nint m_OwningPlayer = 0x16B0; // 
            public const nint m_KillingPlayer = 0x16B4; // 
        }
        // Parent: C_CSGO_TeamPreviewCamera
        // Field count: 0
        ...
        public static class C_SoundOpvarSetPointBase {
            public const nint m_iszStackName = 0x548; // 
            public const nint m_iszOperatorName = 0x550; // 
            public const nint m_iszOpvarName = 0x558; // 
            public const nint m_iOpvarIndex = 0x560; // 
            public const nint m_bUseAutoCompare = 0x564; // 
        }
        // Parent: C_Breakable
        // Field count: 0
        ...
        public static class C_WeaponTaser {
            public const nint m_fFireTime = 0x1A90; // 
            public const nint m_nLastAttackTick = 0x1A94; // 
        }
        // Parent: C_CSWeaponBase
        // Field count: 2
        //
        ...
        public static class C_Fists {
            public const nint m_bPlayingUninterruptableAct = 0x1A70; // 
            public const nint m_nUninterruptableActivity = 0x1A74; // 
        }
        ...
        public static class CInfoDynamicShadowHintBox {
            public const nint m_vBoxMins = 0x560; // 
            public const nint m_vBoxMaxs = 0x56C; // 
        }
        // Parent: C_SoundOpvarSetPointEntity
        // Field count: 0
        ...
        public static class C_EnvCubemapFog {
            public const nint m_flEndDistance = 0x548; // 
            public const nint m_flStartDistance = 0x54C; // 
            public const nint m_flFogFalloffExponent = 0x550; // 
            public const nint m_bHeightFogEnabled = 0x554; // 
            public const nint m_flFogHeightWidth = 0x558; // 
            public const nint m_flFogHeightEnd = 0x55C; // 
            public const nint m_flFogHeightStart = 0x560; // 
            public const nint m_flFogHeightExponent = 0x564; // 
            public const nint m_flLODBias = 0x568; // 
            public const nint m_bActive = 0x56C; // 
            public const nint m_bStartDisabled = 0x56D; // 
            public const nint m_flFogMaxOpacity = 0x570; // 
            public const nint m_nCubemapSourceType = 0x574; // 
            public const nint m_hSkyMaterial = 0x578; // CStrongHandle<InfoForResourceTypeIMaterial2>
            public const nint m_iszSkyEntity = 0x580; // 
            public const nint m_hFogCubemapTexture = 0x588; // 
            public const nint m_bHasHeightFogEnd = 0x590; // 
            public const nint m_bFirstTime = 0x591; // 
        }
        // Parent: C_CSWeaponBase
        // Field count: 0
        ...
        public static class C_PlayerSprayDecal {
            public const nint m_nUniqueID = 0xCC8; // 
            public const nint m_unAccountID = 0xCCC; // 
            public const nint m_unTraceID = 0xCD0; // 
            public const nint m_rtGcTime = 0xCD4; // 
            public const nint m_vecEndPos = 0xCD8; // 
            public const nint m_vecStart = 0xCE4; // 
            public const nint m_vecLeft = 0xCF0; // 
            public const nint m_vecNormal = 0xCFC; // 
            public const nint m_nPlayer = 0xD08; // 
            public const nint m_nEntity = 0xD0C; // 
            public const nint m_nHitbox = 0xD10; // 
            public const nint m_flCreationTime = 0xD14; // 
            public const nint m_nTintID = 0xD18; // 
            public const nint m_nVersion = 0xD1C; // 
            public const nint m_ubSignature = 0xD1D; // 
        ...
        public static class C_ShatterGlassShardPhysics {
            public const nint m_ShardDesc = 0x1050; // 
        }
        // Parent: C_CSWeaponBaseGun
        // Field count: 0
        ...
        public static class C_LightEntity {
            public const nint m_CLightComponent = 0xCC8; // 
        }
        // Parent: C_BaseEntity
        // Field count: 6
        //
        ...
        public static class C_PlayerVisibility {
            public const nint m_flVisibilityStrength = 0x548; // 
            public const nint m_flFogDistanceMultiplier = 0x54C; // 
            public const nint m_flFogMaxDensityMultiplier = 0x550; // 
            public const nint m_flFadeTime = 0x554; // 
            public const nint m_bStartDisabled = 0x558; // 
            public const nint m_bIsEnabled = 0x559; // 
        }
        // Parent: None
        // Field count: 25
        //
        ...
        public static class C_BaseFlex {
            public const nint m_flexWeight = 0xEE0; // 
            public const nint m_vLookTargetPosition = 0xEF8; // 
            public const nint m_blinktoggle = 0xF10; // 
            public const nint m_nLastFlexUpdateFrameCount = 0xF70; // 
            public const nint m_CachedViewTarget = 0xF74; // 
            public const nint m_nNextSceneEventId = 0xF80; // 
            public const nint m_iBlink = 0xF84; // 
            public const nint m_blinktime = 0xF88; // 
            public const nint m_prevblinktoggle = 0xF8C; // 
            public const nint m_iJawOpen = 0xF90; // 
            public const nint m_flJawOpenAmount = 0xF94; // 
            public const nint m_flBlinkAmount = 0xF98; // 
            public const nint m_iMouthAttachment = 0xF9C; // 
            public const nint m_iEyeAttachment = 0xF9D; // 
            public const nint m_bResetFlexWeightsOnModelChange = 0xF9E; // 
            public const nint m_nEyeOcclusionRendererBone = 0xFB8; // 
            public const nint m_mEyeOcclusionRendererCameraToBoneTransform = 0xFBC; // 
            public const nint m_vEyeOcclusionRendererHalfExtent = 0xFEC; // 
            public const nint m_PhonemeClasses = 0x1008; // 
        }
        // Parent: C_BaseEntity
        // Field count: 1
        //
        ...
        public static class C_RagdollManager {
            public const nint m_iCurrentMaxRagdollCount = 0x548; // 
        }
        // Parent: C_BaseModelEntity
        // Field count: 12
        //
        ...
        public static class C_EnvSky {
            ...
            public const nint m_bStartDisabled = 0xCD8; // 
            public const nint m_vTintColor = 0xCD9; // 
            public const nint m_vTintColorLightingOnly = 0xCDD; // 
            public const nint m_flBrightnessScale = 0xCE4; // 
            public const nint m_nFogType = 0xCE8; // 
            public const nint m_flFogMinStart = 0xCEC; // 
            public const nint m_flFogMinEnd = 0xCF0; // 
            public const nint m_flFogMaxStart = 0xCF4; // 
            public const nint m_flFogMaxEnd = 0xCF8; // 
            public const nint m_bEnabled = 0xCFC; // 
        }
        // Parent: C_PointEntity
        // Field count: 0
        ...
        public static class C_DynamicProp {
            public const nint m_bUseHitboxesForRenderBox = 0x1040; // 
            public const nint m_bUseAnimGraph = 0x1041; // 
            public const nint m_pOutputAnimBegun = 0x1048; // 
            public const nint m_pOutputAnimOver = 0x1070; // 
            public const nint m_pOutputAnimLoopCycleOver = 0x1098; // 
            public const nint m_OnAnimReachedStart = 0x10C0; // 
            public const nint m_OnAnimReachedEnd = 0x10E8; // 
            public const nint m_iszIdleAnim = 0x1110; // 
            public const nint m_nIdleAnimLoopMode = 0x1118; // 
            public const nint m_bRandomizeCycle = 0x111C; // 
            public const nint m_bStartDisabled = 0x111D; // 
            public const nint m_bFiredStartEndOutput = 0x111E; // 
            public const nint m_bForceNpcExclude = 0x111F; // 
            public const nint m_bCreateNonSolid = 0x1120; // 
            public const nint m_bIsOverrideProp = 0x1121; // 
            public const nint m_iInitialGlowState = 0x1124; // 
            public const nint m_nGlowRange = 0x1128; // 
            public const nint m_nGlowRangeMin = 0x112C; // 
            public const nint m_glowColor = 0x1130; // 
            public const nint m_nGlowTeam = 0x1134; // 
            public const nint m_iCachedFrameCount = 0x1138; // 
            public const nint m_vecCachedRenderMins = 0x113C; // 
            public const nint m_vecCachedRenderMaxs = 0x1148; // 
        }
        // Parent: CEntityComponent
        // Field count: 10
        ...
        public static class CCitadelSoundOpvarSetOBB {
            public const nint m_iszStackName = 0x560; // 
            public const nint m_iszOperatorName = 0x568; // 
            public const nint m_iszOpvarName = 0x570; // 
            public const nint m_vDistanceInnerMins = 0x578; // 
            public const nint m_vDistanceInnerMaxs = 0x584; // 
            public const nint m_vDistanceOuterMins = 0x590; // 
            public const nint m_vDistanceOuterMaxs = 0x59C; // 
            public const nint m_nAABBDirection = 0x5A8; // 
        }
        // Parent: None
        // Field count: 5
        //
        ...
        public static class C_LocalTempEntity {
            public const nint flags = 0xED0; // 
            public const nint die = 0xED4; // 
            public const nint m_flFrameMax = 0xED8; // 
            public const nint x = 0xEDC; // 
            public const nint y = 0xEE0; // 
            public const nint fadeSpeed = 0xEE4; // 
            public const nint bounceFactor = 0xEE8; // 
            public const nint hitSound = 0xEEC; // 
            public const nint priority = 0xEF0; // 
            public const nint tentOffset = 0xEF4; // 
            public const nint m_vecTempEntAngVelocity = 0xF00; // 
            public const nint tempent_renderamt = 0xF0C; // 
            public const nint m_vecNormal = 0xF10; // 
            public const nint m_flSpriteScale = 0xF1C; // 
            public const nint m_nFlickerFrame = 0xF20; // 
            public const nint m_flFrameRate = 0xF24; // 
            public const nint m_flFrame = 0xF28; // 
            public const nint m_pszImpactEffect = 0xF30; // 
            public const nint m_pszParticleEffect = 0xF38; // 
            public const nint m_bParticleCollision = 0xF40; // 
            public const nint m_iLastCollisionFrame = 0xF44; // 
            public const nint m_vLastCollisionOrigin = 0xF48; // 
            public const nint m_vecTempEntVelocity = 0xF54; // 
            public const nint m_vecPrevAbsOrigin = 0xF60; // 
            public const nint m_vecTempEntAcceleration = 0xF6C; // 
        }
        // Parent: None
        // Field count: 2
        ...
        public static class C_MolotovProjectile {
            public const nint m_bIsIncGrenade = 0x1150; // 
        }
        ...
        public static class CInfoOffscreenPanoramaTexture {
            public const nint m_bDisabled = 0x548; // 
            public const nint m_nResolutionX = 0x54C; // 
            public const nint m_nResolutionY = 0x550; // 
            public const nint m_szLayoutFileName = 0x558; // 
            public const nint m_RenderAttrName = 0x560; // 
            public const nint m_TargetEntities = 0x568; // 
            public const nint m_nTargetChangeCount = 0x580; // 
            public const nint m_vecCSSClasses = 0x588; // C_NetworkUtlVectorBase<CUtlSymbolLarge>
            public const nint m_bCheckCSSClasses = 0x700; // 
        }
        // Parent: C_BaseModelEntity
        // Field count: 7
        //
        ...
        public static class C_DynamicLight {
            public const nint m_Flags = 0xCC8; // 
            public const nint m_LightStyle = 0xCC9; // 
            public const nint m_Radius = 0xCCC; // 
            public const nint m_Exponent = 0xCD0; // 
            public const nint m_InnerAngle = 0xCD4; // 
            public const nint m_OuterAngle = 0xCD8; // 
            public const nint m_SpotRadius = 0xCDC; // 
        }
        ...
        public static class C_CSWeaponBase {
            public const nint m_flFireSequenceStartTime = 0x1624; // 
            public const nint m_nFireSequenceStartTimeChange = 0x1628; // 
            public const nint m_nFireSequenceStartTimeAck = 0x162C; // 
            public const nint m_ePlayerFireEvent = 0x1630; // 
            public const nint m_ePlayerFireEventAttackType = 0x1634; // 
            public const nint m_seqIdle = 0x1638; // 
            public const nint m_seqFirePrimary = 0x163C; // 
            public const nint m_seqFireSecondary = 0x1640; // 
            public const nint m_thirdPersonFireSequences = 0x1648; // 
            public const nint m_hCurrentThirdPersonSequence = 0x1660; // 
            public const nint m_nSilencerBoneIndex = 0x1664; // 
            public const nint m_thirdPersonSequences = 0x1668; // 
            public const nint m_ClientPreviousWeaponState = 0x16A0; // 
            public const nint m_iState = 0x16A4; // 
            public const nint m_flCrosshairDistance = 0x16A8; // 
            public const nint m_iAmmoLastCheck = 0x16AC; // 
            public const nint m_iAlpha = 0x16B0; // 
            public const nint m_iScopeTextureID = 0x16B4; // 
            public const nint m_iCrosshairTextureID = 0x16B8; // 
            public const nint m_flGunAccuracyPositionDeprecated = 0x16BC; // 
            public const nint m_nLastEmptySoundCmdNum = 0x16C0; // 
            public const nint m_nViewModelIndex = 0x16C4; // 
            public const nint m_bReloadsWithClips = 0x16C8; // 
            public const nint m_flTimeWeaponIdle = 0x16CC; // 
            public const nint m_bFireOnEmpty = 0x16D0; // 
            public const nint m_OnPlayerPickup = 0x16D8; // 
            public const nint m_weaponMode = 0x1700; // 
            public const nint m_flTurningInaccuracyDelta = 0x1704; // 
            public const nint m_vecTurningInaccuracyEyeDirLast = 0x1708; // 
            public const nint m_flTurningInaccuracy = 0x1714; // 
            public const nint m_fAccuracyPenalty = 0x1718; // 
            public const nint m_flLastAccuracyUpdateTime = 0x171C; // 
            public const nint m_fAccuracySmoothedForZoom = 0x1720; // 
            public const nint m_fScopeZoomEndTime = 0x1724; // 
            public const nint m_iRecoilIndex = 0x1728; // 
            public const nint m_flRecoilIndex = 0x172C; // 
            public const nint m_bBurstMode = 0x1730; // 
            public const nint m_flLastBurstModeChangeTime = 0x1734; // 
            public const nint m_nPostponeFireReadyTicks = 0x1738; // 
            public const nint m_flPostponeFireReadyFrac = 0x173C; // 
            public const nint m_bInReload = 0x1740; // 
            public const nint m_bReloadVisuallyComplete = 0x1741; // 
            public const nint m_flDroppedAtTime = 0x1744; // 
            public const nint m_bIsHauledBack = 0x1748; // 
            public const nint m_bSilencerOn = 0x1749; // 
            public const nint m_flTimeSilencerSwitchComplete = 0x174C; // 
            public const nint m_iOriginalTeamNumber = 0x1750; // 
            public const nint m_iMostRecentTeamNumber = 0x1754; // 
            public const nint m_bDroppedNearBuyZone = 0x1758; // 
            public const nint m_flNextAttackRenderTimeOffset = 0x175C; // 
            public const nint m_bClearWeaponIdentifyingUGC = 0x17F8; // 
            public const nint m_bVisualsDataSet = 0x17F9; // 
            public const nint m_bOldFirstPersonSpectatedState = 0x17FA; // 
            public const nint m_bUIWeapon = 0x17FB; // 
            public const nint m_nCustomEconReloadEventId = 0x17FC; // 
            public const nint m_hPrevOwner = 0x1808; // 
            public const nint m_nDropTick = 0x180C; // 
            public const nint m_donated = 0x182C; // 
            public const nint m_fLastShotTime = 0x1830; // 
            public const nint m_bWasOwnedByCT = 0x1834; // 
            public const nint m_bWasOwnedByTerrorist = 0x1835; // 
            public const nint m_gunHeat = 0x1838; // 
            public const nint m_smokeAttachments = 0x183C; // 
            public const nint m_lastSmokeTime = 0x1840; // 
            public const nint m_flNextClientFireBulletTime = 0x1844; // 
            public const nint m_flNextClientFireBulletTime_Repredict = 0x1848; // 
            public const nint m_IronSightController = 0x1920; // 
            public const nint m_iIronSightMode = 0x19D0; // 
            public const nint m_flLastLOSTraceFailureTime = 0x19E0; // 
            public const nint m_iNumEmptyAttacks = 0x19E4; // 
            public const nint m_flLastMagDropRequestTime = 0x1A60; // 
            public const nint m_flWatTickOffset = 0x1A64; // 
        }
        // Parent: C_BaseModelEntity
        // Field count: 0
        ...
        public static class C_FuncElectrifiedVolume {
            public const nint m_nAmbientEffect = 0xCC8; // 
            public const nint m_EffectName = 0xCD0; // 
            public const nint m_bState = 0xCD8; // 
        }
        ...
        public static class C_EnvDetailController {
            public const nint m_flFadeStartDist = 0x548; // 
            public const nint m_flFadeEndDist = 0x54C; // 
        }
        ...
        public static class C_BaseEntity {
            ...
            public const nint m_nLastThinkTick = 0x300; // 
            public const nint m_pGameSceneNode = 0x308; // 
            public const nint m_pRenderComponent = 0x310; // 
            public const nint m_pCollision = 0x318; // 
            public const nint m_iMaxHealth = 0x320; // 
            public const nint m_iHealth = 0x324; // 
            public const nint m_lifeState = 0x328; // 
            public const nint m_bTakesDamage = 0x329; // 
            public const nint m_nTakeDamageFlags = 0x330; // 
            public const nint m_bIsPlatform = 0x338; // 
            public const nint m_ubInterpolationFrame = 0x339; // 
            ...
            public const nint m_bDisabledContextThinks = 0x388; // 
            public const nint m_flAnimTime = 0x38C; // 
            public const nint m_flSimulationTime = 0x390; // 
            public const nint m_nSceneObjectOverrideFlags = 0x394; // 
            public const nint m_bHasSuccessfullyInterpolated = 0x395; // 
            public const nint m_bHasAddedVarsToInterpolation = 0x396; // 
            public const nint m_bRenderEvenWhenNotSuccessfullyInterpolated = 0x397; // 
            public const nint m_nInterpolationLatchDirtyFlags = 0x398; // 
            public const nint m_ListEntry = 0x3A0; // 
            public const nint m_flCreateTime = 0x3B8; // 
            public const nint m_flSpeed = 0x3BC; // 
            public const nint m_EntClientFlags = 0x3C0; // 
            public const nint m_bClientSideRagdoll = 0x3C2; // 
            public const nint m_iTeamNum = 0x3C3; // 
            public const nint m_spawnflags = 0x3C4; // 
            public const nint m_nNextThinkTick = 0x3C8; // 
            public const nint m_fFlags = 0x3CC; // 
            public const nint m_vecAbsVelocity = 0x3D0; // 
            public const nint m_vecVelocity = 0x3E0; // 
            public const nint m_vecBaseVelocity = 0x410; // 
            public const nint m_hEffectEntity = 0x41C; // 
            public const nint m_hOwnerEntity = 0x420; // 
            public const nint m_MoveCollide = 0x424; // 
            public const nint m_MoveType = 0x425; // 
            public const nint m_nActualMoveType = 0x426; // 
            public const nint m_flWaterLevel = 0x428; // 
            public const nint m_fEffects = 0x42C; // 
            public const nint m_hGroundEntity = 0x430; // 
            public const nint m_nGroundBodyIndex = 0x434; // 
            public const nint m_flFriction = 0x438; // 
            public const nint m_flElasticity = 0x43C; // 
            public const nint m_flGravityScale = 0x440; // 
            public const nint m_flTimeScale = 0x444; // 
            public const nint m_bAnimatedEveryTick = 0x448; // 
            public const nint m_flNavIgnoreUntilTime = 0x44C; // 
            public const nint m_hThink = 0x450; // 
            public const nint m_fBBoxVisFlags = 0x460; // 
            public const nint m_bPredictable = 0x461; // 
            public const nint m_bRenderWithViewModels = 0x462; // 
            public const nint m_nSplitUserPlayerPredictionSlot = 0x464; // 
            public const nint m_nFirstPredictableCommand = 0x468; // 
            public const nint m_nLastPredictableCommand = 0x46C; // 
            public const nint m_hOldMoveParent = 0x470; // 
            public const nint m_Particles = 0x478; // 
            public const nint m_vecPredictedScriptFloats = 0x4A0; // 
            public const nint m_vecPredictedScriptFloatIDs = 0x4B8; // 
            public const nint m_nNextScriptVarRecordID = 0x4E8; // 
            public const nint m_vecAngVelocity = 0x4F8; // 
            public const nint m_DataChangeEventRef = 0x504; // 
            public const nint m_dependencies = 0x508; // 
            public const nint m_nCreationTick = 0x520; // 
            public const nint m_bAnimTimeChanged = 0x52D; // 
            public const nint m_bSimulationTimeChanged = 0x52E; // 
            public const nint m_sUniqueHammerID = 0x538; // 
            public const nint m_nBloodType = 0x540; // 
        }
        // Parent: None
        // Field count: 11
        //
        ...
        public static class C_PhysicsProp {
            public const nint m_bAwake = 0x1040; // 
        }
        // Parent: CBaseProp
        // Field count: 26
        //
        ...
        public static class C_BreakableProp {
            public const nint m_CPropDataComponent = 0xF10; // 
            public const nint m_OnBreak = 0xF50; // 
            public const nint m_OnHealthChanged = 0xF78; // CEntityOutputTemplate<float32>
            public const nint m_OnTakeDamage = 0xFA0; // 
            public const nint m_impactEnergyScale = 0xFC8; // 
            public const nint m_iMinHealthDmg = 0xFCC; // 
            public const nint m_flPressureDelay = 0xFD0; // 
            public const nint m_flDefBurstScale = 0xFD4; // 
            public const nint m_vDefBurstOffset = 0xFD8; // 
            public const nint m_hBreaker = 0xFE4; // 
            public const nint m_PerformanceMode = 0xFE8; // 
            public const nint m_flPreventDamageBeforeTime = 0xFEC; // 
            public const nint m_bHasBreakPiecesOrCommands = 0xFF0; // 
            public const nint m_explodeDamage = 0xFF4; // 
            public const nint m_explodeRadius = 0xFF8; // 
            public const nint m_explosionDelay = 0x1000; // 
            public const nint m_explosionBuildupSound = 0x1008; // 
            public const nint m_explosionCustomEffect = 0x1010; // 
            public const nint m_explosionCustomSound = 0x1018; // 
            public const nint m_explosionModifier = 0x1020; // 
            public const nint m_hPhysicsAttacker = 0x1028; // 
            public const nint m_flLastPhysicsInfluenceTime = 0x102C; // 
            public const nint m_flDefaultFadeScale = 0x1030; // 
            public const nint m_hLastAttacker = 0x1034; // 
            public const nint m_hFlareEnt = 0x1038; // 
            public const nint m_noGhostCollision = 0x103C; // 
        }
        // Parent: C_BaseToggle
        // Field count: 0
        //
        ...
        public static class C_Beam {
            public const nint m_flFrameRate = 0xCC8; // 
            public const nint m_flHDRColorScale = 0xCCC; // 
            public const nint m_flFireTime = 0xCD0; // 
            public const nint m_flDamage = 0xCD4; // 
            public const nint m_nNumBeamEnts = 0xCD8; // 
            public const nint m_queryHandleHalo = 0xCDC; // 
            ...
            public const nint m_nBeamType = 0xD10; // 
            public const nint m_nBeamFlags = 0xD14; // 
            public const nint m_hAttachEntity = 0xD18; // 
            public const nint m_nAttachIndex = 0xD40; // 
            public const nint m_fWidth = 0xD4C; // 
            public const nint m_fEndWidth = 0xD50; // 
            public const nint m_fFadeLength = 0xD54; // 
            public const nint m_fHaloScale = 0xD58; // 
            public const nint m_fAmplitude = 0xD5C; // 
            public const nint m_fStartFrame = 0xD60; // 
            public const nint m_fSpeed = 0xD64; // 
            public const nint m_flFrame = 0xD68; // 
            public const nint m_nClipStyle = 0xD6C; // 
            public const nint m_bTurnedOff = 0xD70; // 
            public const nint m_vecEndPos = 0xD74; // 
            public const nint m_hEndEntity = 0xD80; // 
        }
        // Parent: C_BaseEntity
        // Field count: 8
        //
        ...
        public static class C_CSGO_TeamPreviewCharacterPosition {
            public const nint m_nVariant = 0x548; // 
            public const nint m_nRandom = 0x54C; // 
            public const nint m_nOrdinal = 0x550; // 
            public const nint m_sWeaponName = 0x558; // 
            public const nint m_xuid = 0x560; // 
            public const nint m_agentItem = 0x568; // 
            public const nint m_glovesItem = 0x9B0; // 
            public const nint m_weaponItem = 0xDF8; // 
        }
        // Parent: C_DynamicProp
        // Field count: 0
        ...
        public static class C_EnvScreenOverlay {
            public const nint m_iszOverlayNames = 0x548; // 
            public const nint m_flOverlayTimes = 0x598; // 
            public const nint m_flStartTime = 0x5C0; // 
            public const nint m_iDesiredOverlay = 0x5C4; // 
            public const nint m_bIsActive = 0x5C8; // 
            public const nint m_bWasActive = 0x5C9; // 
            public const nint m_iCachedDesiredOverlay = 0x5CC; // 
            public const nint m_iCurrentOverlay = 0x5D0; // 
            public const nint m_flCurrentOverlayTime = 0x5D4; // 
        }
        ...
        public static class CCSWeaponBaseVData {
            ...
            public const nint m_szHeatEffect = 0x6B8; // 
            public const nint m_szEjectBrassEffect = 0x798; // 
            public const nint m_szMuzzleFlashParticleAlt = 0x878; // 
            public const nint m_szMuzzleFlashThirdPersonParticle = 0x958; // 
            public const nint m_szMuzzleFlashThirdPersonParticleAlt = 0xA38; // 
            public const nint m_szTracerParticle = 0xB18; // 
        ...
        public static class C_PointWorldText {
            public const nint m_bForceRecreateNextUpdate = 0xCD0; // 
            public const nint m_messageText = 0xCE0; // 
            public const nint m_FontName = 0xEE0; // 
            public const nint m_bEnabled = 0xF20; // 
            public const nint m_bFullbright = 0xF21; // 
            public const nint m_flWorldUnitsPerPx = 0xF24; // 
            public const nint m_flFontSize = 0xF28; // 
            public const nint m_flDepthOffset = 0xF2C; // 
            public const nint m_Color = 0xF30; // 
            public const nint m_nJustifyHorizontal = 0xF34; // 
            public const nint m_nJustifyVertical = 0xF38; // 
            public const nint m_nReorientMode = 0xF3C; // 
        }
        // Parent: C_BaseGrenade
        // Field count: 0
        ...
        public static class CCSPlayerController {
            ...
            public const nint m_iPing = 0x710; // 
            public const nint m_bHasCommunicationAbuseMute = 0x714; // 
            public const nint m_szCrosshairCodes = 0x718; // 
            public const nint m_iPendingTeamNum = 0x720; // 
            public const nint m_flForceTeamTime = 0x724; // 
            public const nint m_iCompTeammateColor = 0x728; // 
            public const nint m_bEverPlayedOnTeam = 0x72C; // 
            public const nint m_flPreviousForceJoinTeamTime = 0x730; // 
            public const nint m_szClan = 0x738; // 
            public const nint m_sSanitizedPlayerName = 0x740; // 
            public const nint m_iCoachingTeam = 0x748; // 
            public const nint m_nPlayerDominated = 0x750; // 
            public const nint m_nPlayerDominatingMe = 0x758; // 
            public const nint m_iCompetitiveRanking = 0x760; // 
            public const nint m_iCompetitiveWins = 0x764; // 
            public const nint m_iCompetitiveRankType = 0x768; // 
            public const nint m_iCompetitiveRankingPredicted_Win = 0x76C; // 
            public const nint m_iCompetitiveRankingPredicted_Loss = 0x770; // 
            public const nint m_iCompetitiveRankingPredicted_Tie = 0x774; // 
            public const nint m_nEndMatchNextMapVote = 0x778; // 
            public const nint m_unActiveQuestId = 0x77C; // 
            public const nint m_nQuestProgressReason = 0x780; // 
            public const nint m_unPlayerTvControlFlags = 0x784; // 
            public const nint m_iDraftIndex = 0x7B0; // 
            public const nint m_msQueuedModeDisconnectionTimestamp = 0x7B4; // 
            public const nint m_uiAbandonRecordedReason = 0x7B8; // 
            public const nint m_bCannotBeKicked = 0x7BC; // 
            public const nint m_bEverFullyConnected = 0x7BD; // 
            public const nint m_bAbandonAllowsSurrender = 0x7BE; // 
            public const nint m_bAbandonOffersInstantSurrender = 0x7BF; // 
            public const nint m_bDisconnection1MinWarningPrinted = 0x7C0; // 
            public const nint m_bScoreReported = 0x7C1; // 
            public const nint m_nDisconnectionTick = 0x7C4; // 
            public const nint m_bControllingBot = 0x7D0; // 
            public const nint m_bHasControlledBotThisRound = 0x7D1; // 
            public const nint m_bHasBeenControlledByPlayerThisRound = 0x7D2; // 
            public const nint m_nBotsControlledThisRound = 0x7D4; // 
            public const nint m_bCanControlObservedBot = 0x7D8; // 
            public const nint m_hPlayerPawn = 0x7DC; // 
            public const nint m_hObserverPawn = 0x7E0; // 
            public const nint m_bPawnIsAlive = 0x7E4; // 
            public const nint m_iPawnHealth = 0x7E8; // 
            public const nint m_iPawnArmor = 0x7EC; // 
            public const nint m_bPawnHasDefuser = 0x7F0; // 
            public const nint m_bPawnHasHelmet = 0x7F1; // 
            public const nint m_nPawnCharacterDefIndex = 0x7F2; // 
            public const nint m_iPawnLifetimeStart = 0x7F4; // 
            public const nint m_iPawnLifetimeEnd = 0x7F8; // 
            public const nint m_iPawnBotDifficulty = 0x7FC; // 
            public const nint m_hOriginalControllerOfCurrentPawn = 0x800; // 
            public const nint m_iScore = 0x804; // 
            public const nint m_vecKills = 0x808; // C_NetworkUtlVectorBase<EKillTypes_t>
            public const nint m_bMvpNoMusic = 0x820; // 
            public const nint m_eMvpReason = 0x824; // 
            public const nint m_iMusicKitID = 0x828; // 
            public const nint m_iMusicKitMVPs = 0x82C; // 
            public const nint m_iMVPs = 0x830; // 
            public const nint m_bIsPlayerNameDirty = 0x834; // 
        }
        // Parent: C_CSWeaponBaseGun
        // Field count: 0
        ...
        public static class C_BasePropDoor {
            public const nint m_eDoorState = 0x1168; // 
            public const nint m_modelChanged = 0x116C; // 
            public const nint m_bLocked = 0x116D; // 
            public const nint m_closedPosition = 0x1170; // 
            public const nint m_closedAngles = 0x117C; // 
            public const nint m_hMaster = 0x1188; // 
            public const nint m_vWhereToSetLightingOrigin = 0x118C; // 
        }
        // Parent: C_CSGO_TeamSelectCharacterPosition
        // Field count: 0
        ...
        public static class C_PhysPropClientside {
            public const nint m_flTouchDelta = 0x1040; // 
            public const nint m_fDeathTime = 0x1044; // 
            public const nint m_inertiaScale = 0x1048; // 
            public const nint m_vecDamagePosition = 0x104C; // 
            public const nint m_vecDamageDirection = 0x1058; // 
            public const nint m_nDamageType = 0x1064; // 
        }
        // Parent: C_CSGO_TeamPreviewCamera
        // Field count: 0
        ...
        public static class C_SoundAreaEntityBase {
            public const nint m_bDisabled = 0x548; // 
            public const nint m_bWasEnabled = 0x550; // 
            public const nint m_iszSoundAreaType = 0x558; // 
            public const nint m_vPos = 0x560; // 
        }
        // Parent: C_BaseEntity
        // Field count: 3
        //
        ...
        public static class C_FogController {
            public const nint m_fog = 0x548; // 
            public const nint m_bUseAngles = 0x5B0; // 
            public const nint m_iChangedVariables = 0x5B4; // 
        }
        // Parent: CPlayerPawnComponent
        // Field count: 0
        ...
        public static class CInfoWorldLayer {
            public const nint m_pOutputOnEntitiesSpawned = 0x548; // 
            public const nint m_worldName = 0x570; // 
            public const nint m_layerName = 0x578; // 
            public const nint m_bWorldLayerVisible = 0x580; // 
            public const nint m_bEntitiesSpawned = 0x581; // 
            public const nint m_bCreateAsChildSpawnGroup = 0x582; // 
            public const nint m_hLayerSpawnGroup = 0x584; // 
            public const nint m_bWorldLayerActuallyVisible = 0x588; // 
        }
        // Parent: C_BaseCombatCharacter
        // Field count: 0
        ...
        public static class C_ViewmodelWeapon {
            public const nint m_worldModel = 0xED0; // 
        }
        // Parent: CBaseAnimGraph
        // Field count: 2
        public static class C_PhysMagnet {
            public const nint m_aAttachedObjectsFromServer = 0xED0; // 
        ...
        public static class C_FuncConveyor {
            public const nint m_vecMoveDirEntitySpace = 0xCD0; // 
            public const nint m_flTargetSpeed = 0xCDC; // 
            public const nint m_nTransitionStartTick = 0xCE0; // 
            public const nint m_nTransitionDurationTicks = 0xCE4; // 
            public const nint m_flTransitionStartSpeed = 0xCE8; // 
            public const nint m_hConveyorModels = 0xCF0; // 
            public const nint m_flCurrentConveyorOffset = 0xD08; // 
            public const nint m_flCurrentConveyorSpeed = 0xD0C; // 
        }
        // Parent: None
        // Field count: 4
        //
        ...
        public static class C_BaseViewModel {
            public const nint m_vecLastFacing = 0xED8; // 
            public const nint m_nViewModelIndex = 0xEE4; // 
            public const nint m_nAnimationParity = 0xEE8; // 
            public const nint m_flAnimationStartTime = 0xEEC; // 
            public const nint m_hWeapon = 0xEF0; // 
            public const nint m_sVMName = 0xEF8; // 
            public const nint m_sAnimationPrefix = 0xF00; // 
            public const nint m_hWeaponModel = 0xF08; // 
            public const nint m_iCameraAttachment = 0xF0C; // 
            public const nint m_vecLastCameraAngles = 0xF10; // 
            public const nint m_previousElapsedDuration = 0xF1C; // 
            public const nint m_previousCycle = 0xF20; // 
            public const nint m_nOldAnimationParity = 0xF24; // 
            public const nint m_hOldLayerSequence = 0xF28; // 
            public const nint m_oldLayer = 0xF2C; // 
            public const nint m_oldLayerStartTime = 0xF30; // 
            public const nint m_hControlPanel = 0xF34; // 
        }
        ...
        public static class C_CSObserverPawn {
            public const nint m_hDetectParentChange = 0x1460; // 
        }
        // Parent: C_BaseEntity
        // Field count: 3
        //
        ...
        public static class C_EntityFlame {
            public const nint m_hEntAttached = 0x548; // 
            public const nint m_hOldAttached = 0x570; // 
            public const nint m_bCheapEffect = 0x574; // 
        }
        // Parent: C_BaseGrenade
        // Field count: 0
        ...
        public static class C_Hostage {
            public const nint m_entitySpottedState = 0x10F8; // 
            public const nint m_leader = 0x1110; // 
            public const nint m_reuseTimer = 0x1118; // 
            public const nint m_vel = 0x1130; // 
            public const nint m_isRescued = 0x113C; // 
            public const nint m_jumpedThisFrame = 0x113D; // 
            public const nint m_nHostageState = 0x1140; // 
            public const nint m_bHandsHaveBeenCut = 0x1144; // 
            public const nint m_hHostageGrabber = 0x1148; // 
            public const nint m_fLastGrabTime = 0x114C; // 
            public const nint m_vecGrabbedPos = 0x1150; // 
            public const nint m_flRescueStartTime = 0x115C; // 
            public const nint m_flGrabSuccessTime = 0x1160; // 
            public const nint m_flDropStartTime = 0x1164; // 
            public const nint m_flDeadOrRescuedTime = 0x1168; // 
            public const nint m_blinkTimer = 0x1170; // 
            public const nint m_lookAt = 0x1188; // 
            public const nint m_lookAroundTimer = 0x1198; // 
            public const nint m_isInit = 0x11B0; // 
            public const nint m_eyeAttachment = 0x11B1; // 
            public const nint m_chestAttachment = 0x11B2; // 
            public const nint m_pPredictionOwner = 0x11B8; // 
            public const nint m_fNewestAlphaThinkTime = 0x11C0; // 
        }
        // Parent: C_BaseModelEntity
        // Field count: 24
        //
        ...
        public static class C_Sprite {
            ...
            public const nint m_hAttachedToEntity = 0xCD0; // 
            public const nint m_nAttachment = 0xCD4; // 
            public const nint m_flSpriteFramerate = 0xCD8; // 
            public const nint m_flFrame = 0xCDC; // 
            public const nint m_flDieTime = 0xCE0; // 
            public const nint m_nBrightness = 0xCF0; // 
            public const nint m_flBrightnessDuration = 0xCF4; // 
            public const nint m_flSpriteScale = 0xCF8; // 
            public const nint m_flScaleDuration = 0xCFC; // 
            public const nint m_bWorldSpaceScale = 0xD00; // 
            public const nint m_flGlowProxySize = 0xD04; // 
            public const nint m_flHDRColorScale = 0xD08; // 
            public const nint m_flLastTime = 0xD0C; // 
            public const nint m_flMaxFrame = 0xD10; // 
            public const nint m_flStartScale = 0xD14; // 
            public const nint m_flDestScale = 0xD18; // 
            public const nint m_flScaleTimeStart = 0xD1C; // 
            public const nint m_nStartBrightness = 0xD20; // 
            public const nint m_nDestBrightness = 0xD24; // 
            public const nint m_flBrightnessTimeStart = 0xD28; // 
            public const nint m_hOldSpriteMaterial = 0xD30; // CWeakHandle<InfoForResourceTypeIMaterial2>
            public const nint m_nSpriteWidth = 0xDD0; // 
            public const nint m_nSpriteHeight = 0xDD4; // 
        }
        // Parent: C_CSWeaponBaseGun
        // Field count: 0
        ...
        public static class C_PlantedC4 {
            public const nint m_bBombTicking = 0xED0; // 
            public const nint m_nBombSite = 0xED4; // 
            public const nint m_nSourceSoundscapeHash = 0xED8; // 
            public const nint m_entitySpottedState = 0xEE0; // 
            public const nint m_flNextGlow = 0xEF8; // 
            public const nint m_flNextBeep = 0xEFC; // 
            public const nint m_flC4Blow = 0xF00; // 
            public const nint m_bCannotBeDefused = 0xF04; // 
            public const nint m_bHasExploded = 0xF05; // 
            public const nint m_flTimerLength = 0xF08; // 
            public const nint m_bBeingDefused = 0xF0C; // 
            public const nint m_bTriggerWarning = 0xF10; // 
            public const nint m_bExplodeWarning = 0xF14; // 
            public const nint m_bC4Activated = 0xF18; // 
            public const nint m_bTenSecWarning = 0xF19; // 
            public const nint m_flDefuseLength = 0xF1C; // 
            public const nint m_flDefuseCountDown = 0xF20; // 
            public const nint m_bBombDefused = 0xF24; // 
            public const nint m_hBombDefuser = 0xF28; // 
            public const nint m_hControlPanel = 0xF2C; // 
            public const nint m_hDefuserMultimeter = 0xF30; // 
            public const nint m_flNextRadarFlashTime = 0xF34; // 
            public const nint m_bRadarFlash = 0xF38; // 
            public const nint m_pBombDefuser = 0xF3C; // 
            public const nint m_fLastDefuseTime = 0xF40; // 
            public const nint m_pPredictionOwner = 0xF48; // 
            public const nint m_vecC4ExplodeSpectatePos = 0xF50; // 
            public const nint m_vecC4ExplodeSpectateAng = 0xF5C; // 
            public const nint m_flC4ExplodeSpectateDuration = 0xF68; // 
        }
        // Parent: CBaseAnimGraph
        // Field count: 8
        //
        ...
        public static class C_RagdollProp {
            ...
            public const nint m_flBlendWeight = 0xF08; // 
            public const nint m_hRagdollSource = 0xF0C; // 
            public const nint m_iEyeAttachment = 0xF10; // 
            public const nint m_flBlendWeightCurrent = 0xF14; // 
            public const nint m_parentPhysicsBoneIndices = 0xF18; // 
            public const nint m_worldSpaceBoneComputationOrder = 0xF30; // 
        }
        // Parent: C_CSGO_TeamPreviewCamera
        // Field count: 0
        ...
        public static class C_VoteController {
            public const nint m_iActiveIssueIndex = 0x558; // 
            public const nint m_iOnlyTeamToVote = 0x55C; // 
            public const nint m_nVoteOptionCount = 0x560; // 
            public const nint m_nPotentialVotes = 0x574; // 
            public const nint m_bVotesDirty = 0x578; // 
            public const nint m_bTypeDirty = 0x579; // 
            public const nint m_bIsYesNoVote = 0x57A; // 
        }
        // Parent: None
        // Field count: 3
        //
        ...
        public static class C_Chicken {
            public const nint m_hHolidayHatAddon = 0x1160; // 
            public const nint m_jumpedThisFrame = 0x1164; // 
            public const nint m_leader = 0x1168; // 
            public const nint m_AttributeManager = 0x1170; // 
            public const nint m_bAttributesInitialized = 0x1618; // 
            public const nint m_hWaterWakeParticles = 0x161C; // 
            public const nint m_bIsPreviewModel = 0x1620; // 
        }
        // Parent: None
        // Field count: 4
        //
